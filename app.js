...
const PREGUNTES = {
 ...
 senyals: [
  ...
  // ===== 1. SENYALS DE PERILL P-1 A P-30 =====
  { id: "P-1", categoria: "perill", pregunta: "Què indica aquest senyal?", tipusSBG: "perill", emoji: "⛔", sbg_base: "triangulo_roig", opcions: ["Intersecció", "Stop", "Ceda el pas"], correcta: 0 },
  { id: "P-2", categoria: "perill", pregunta: "Què indica aquest senyal?", tipusSBG: "perill", emoji: "⛔", sbg_base: "triangulo_roig", opcions: ["Intersecció amb prioritat", "Stop", "Ceda el pas"], correcta: 0 },
  { id: "P-3", categoria: "perill", pregunta: "Què indica aquest senyal?", tipusSBG: "perill", emoji: "🚦", sbg_base: "triangulo_roig", opcions: ["Proximitat semàfors", "Zona escolar", "Creuament"], correcta: 0 },
  { id: "P-4", categoria: "perill", pregunta: "Què indica aquest senyal?", tipusSBG: "perill", emoji: "↪️", sbg_base: "triangulo_roig", opcions: ["Gir perillós a la dreta", "Gir obligatori dreta", "Desviament"], correcta: 0 },
  { id: "P-5", categoria: "perill", pregunta: "Què indica aquest senyal?", tipusSBG: "perill", emoji: "↩️", sbg_base: "triangulo_roig", opcions: ["Gir perillós a l'esquerra", "Gir obligatori esquerra", "Desviament"], correcta: 0 },
  { id: "P-6", categoria: "perill", pregunta: "Què indica aquest senyal?", tipusSBG: "perill", emoji: "↪️", sbg_base: "triangulo_roig", opcions: ["Corba perillosa a la dreta", "Corba obligatòria", "Desviament"], correcta: 0 },
  { id: "P-7", categoria: "perill", pregunta: "Què indica aquest senyal?", tipusSBG: "perill", emoji: "↩️", sbg_base: "triangulo_roig", opcions: ["Corba perillosa a l'esquerra", "Corba obligatòria", "Desviament"], correcta: 0 },
  { id: "P-8", categoria: "perill", pregunta: "Què indica aquest senyal?", tipusSBG: "perill", emoji: "〰️", sbg_base: "triangulo_roig", opcions: ["Corbes perilloses", "Baixada pronunciada", "Calçada estreta"], correcta: 0 },
  { id: "P-9", categoria: "perill", pregunta: "Què indica aquest senyal?", tipusSBG: "perill", emoji: "🔻", sbg_base: "triangulo_roig", opcions: ["Baixada pronunciada", "Pujada pronunciada", "Desnivell"], correcta: 0 },
  { id: "P-10", categoria: "perill", pregunta: "Què indica aquest senyal?", tipusSBG: "perill", emoji: "🔺", sbg_base: "triangulo_roig", opcions: ["Pujada pronunciada", "Baixada pronunciada", "Desnivell"], correcta: 0 },
  { id: "P-11", categoria: "perill", pregunta: "Què indica aquest senyal?", tipusSBG: "perill", emoji: "↔️", sbg_base: "triangulo_roig", opcions: ["Estretament de calçada", "Calçada lliscant", "Obres"], correcta: 0 },
  { id: "P-12", categoria: "perill", pregunta: "Què indica aquest senyal?", tipusSBG: "perill", emoji: "🌉", sbg_base: "triangulo_roig", opcions: ["Pont mòbil", "Pas superior", "Túnel"], correcta: 0 },
  { id: "P-13", categoria: "perill", pregunta: "Què indica aquest senyal?", tipusSBG: "perill", emoji: "🌊", sbg_base: "triangulo_roig", opcions: ["Sortida a un moll", "Zona inundable", "Platja"], correcta: 0 },
  { id: "P-14", categoria: "perill", pregunta: "Què indica aquest senyal?", tipusSBG: "perill", emoji: "💦", sbg_base: "triangulo_roig", opcions: ["Calçada lliscant", "Pluja", "Obres"], correcta: 0 },
  { id: "P-15", categoria: "perill", pregunta: "Què indica aquest senyal?", tipusSBG: "perill", emoji: "🪨", sbg_base: "triangulo_roig", opcions: ["Projecció de graveta", "Caiguda de pedres", "Obres"], correcta: 0 },
  { id: "P-16", categoria: "perill", pregunta: "Què indica aquest senyal?", tipusSBG: "perill", emoji: "🪨", sbg_base: "triangulo_roig", opcions: ["Caiguda de pedres", "Projecció de graveta", "Obres"], correcta: 0 },
  { id: "P-17", categoria: "perill", pregunta: "Què indica aquest senyal?", tipusSBG: "perill", emoji: "🚶", sbg_base: "triangulo_roig", opcions: ["Pas de vianants", "Zona escolar", "Prohibit vianants"], correcta: 0 },
  { id: "P-18", categoria: "perill", pregunta: "Què indica aquest senyal?", tipusSBG: "perill", emoji: "🚴", sbg_base: "triangulo_roig", opcions: ["Pas de ciclistes", "Carril bici", "Prohibit bicis"], correcta: 0 },
  { id: "P-19", categoria: "perill", pregunta: "Què indica aquest senyal?", tipusSBG: "perill", emoji: "🦌", sbg_base: "triangulo_roig", opcions: ["Pas d'animals en llibertat", "Zona ramadera", "Prohibit animals"], correcta: 0 },
  { id: "P-20", categoria: "perill", pregunta: "Què indica aquest senyal?", tipusSBG: "perill", emoji: "⚠️", sbg_base: "triangulo_roig", opcions: ["Altres perills", "Perill genèric", "Obres"], correcta: 0 },
  { id: "P-21", categoria: "perill", pregunta: "Què indica aquest senyal?", tipusSBG: "perill", emoji: "🚸", sbg_base: "triangulo_roig", opcions: ["Nens", "Zona escolar", "Pas de vianants"], correcta: 0 },
  { id: "P-22", categoria: "perill", pregunta: "Què indica aquest senyal?", tipusSBG: "perill", emoji: "🐴", sbg_base: "triangulo_roig", opcions: ["Pas d'animals de tir", "Zona ramadera", "Prohibit cavalls"], correcta: 0 },
  { id: "P-23", categoria: "perill", pregunta: "Què indica aquest senyal?", tipusSBG: "perill", emoji: "💨", sbg_base: "triangulo_roig", opcions: ["Vent lateral", "Ràfegues de vent", "Tempesta"], correcta: 0 },
  { id: "P-24", categoria: "perill", pregunta: "Què indica aquest senyal?", tipusSBG: "perill", emoji: "↔️", sbg_base: "triangulo_roig", opcions: ["Circulació en els dos sentits", "Doble sentit", "Canvi de sentit"], correcta: 0 },
  { id: "P-25", categoria: "perill", pregunta: "Què indica aquest senyal?", tipusSBG: "perill", emoji: "🚗🚗", sbg_base: "triangulo_roig", opcions: ["Embossos", "Circulació lenta", "Obres"], correcta: 0 },
  { id: "P-26", categoria: "perill", pregunta: "Què indica aquest senyal?", tipusSBG: "perill", emoji: "🚧", sbg_base: "triangulo_roig", opcions: ["Obres", "Perill", "Desviament"], correcta: 0 },
  { id: "P-27", categoria: "perill", pregunta: "Què indica aquest senyal?", tipusSBG: "perill", emoji: "🌨️", sbg_base: "triangulo_roig", opcions: ["Tram amb neu", "Gel", "Fred"], correcta: 0 },
  { id: "P-28", categoria: "perill", pregunta: "Què indica aquest senyal?", tipusSBG: "perill", emoji: "💦", sbg_base: "triangulo_roig", opcions: ["Terra relliscós", "Calçada lliscant", "Pluja"], correcta: 0 },
  { id: "P-29", categoria: "perill", pregunta: "Què indica aquest senyal?", tipusSBG: "perill", emoji: "🚨", sbg_base: "triangulo_roig", opcions: ["Accident", "Perill", "Obres"], correcta: 0 },
  { id: "P-30", categoria: "perill", pregunta: "Què indica aquest senyal?", tipusSBG: "perill", emoji: "🚂", sbg_base: "triangulo_roig", opcions: ["Pas a nivell amb barreres", "Tren", "Perill ferroviari"], correcta: 0 },

  // ===== 2. SENYALS DE PROHIBICIÓ R-1 A R-50 =====
  { id: "R-1", categoria: "prohibit", pregunta: "Què indica aquest senyal?", tipusSBG: "prohibit", emoji: "🔻", sbg_base: "circulo_rojo_barra", opcions: ["Prioritat al pas", "Ceda el pas", "Stop"], correcta: 0 },
  { id: "R-2", categoria: "prohibit", pregunta: "Què indica aquest senyal?", tipusSBG: "prohibit", emoji: "🛑", sbg_base: "octogon_roig", opcions: ["Stop", "Ceda el pas", "Prohibit"], correcta: 0 },
  { id: "R-3", categoria: "prohibit", pregunta: "Què indica aquest senyal?", tipusSBG: "prohibit", emoji: "↪️", sbg_base: "circulo_rojo_barra", opcions: ["Prohibit girar a la dreta", "Gir obligatori dreta", "Direcció única"], correcta: 0 },
  { id: "R-4", categoria: "prohibit", pregunta: "Què indica aquest senyal?", tipusSBG: "prohibit", emoji: "↩️", sbg_base: "circulo_rojo_barra", opcions: ["Prohibit girar a l'esquerra", "Gir obligatori esquerra", "Direcció única"], correcta: 0 },
  { id: "R-5", categoria: "prohibit", pregunta: "Què indica aquest senyal?", tipusSBG: "prohibit", emoji: "🔄", sbg_base: "circulo_rojo_barra", opcions: ["Prohibit girar en U", "Canvi de sentit obligatori", "Rotonda"], correcta: 0 },
  { id: "R-6", categoria: "prohibit", pregunta: "Què indica aquest senyal?", tipusSBG: "prohibit", emoji: "🚗", sbg_base: "circulo_rojo_barra", opcions: ["Prohibit avançar", "Prohibit circular", "Velocitat mínima"], correcta: 0 },
  { id: "R-7", categoria: "prohibit", pregunta: "Què indica aquest senyal?", tipusSBG: "prohibit", emoji: "↩️", sbg_base: "circulo_rojo_barra", opcions: ["Prohibit canviar de sentit", "Gir obligatori", "Rotonda"], correcta: 0 },
  { id: "R-8", categoria: "prohibit", pregunta: "Què indica aquest senyal?", tipusSBG: "prohibit", emoji: "🚫", sbg_base: "circulo_rojo_barra", opcions: ["Prohibit circular", "Fi de prohibicions", "Zona peatonal"], correcta: 0 },
  { id: "R-9", categoria: "prohibit", pregunta: "Què indica aquest senyal?", tipusSBG: "prohibit", emoji: "🚛", sbg_base: "circulo_rojo_barra", opcions: ["Prohibit camions", "Zona de càrrega", "Aparcament camions"], correcta: 0 },
  { id: "R-10", categoria: "prohibit", pregunta: "Què indica aquest senyal?", tipusSBG: "prohibit", emoji: "🏍️", sbg_base: "circulo_rojo_barra", opcions: ["Prohibit motocicletes", "Prohibit cotxes", "Zona 30"], correcta: 0 },
  { id: "R-11", categoria: "prohibit", pregunta: "Què indica aquest senyal?", tipusSBG: "prohibit", emoji: "🚴", sbg_base: "circulo_rojo_barra", opcions: ["Prohibit bicicletes", "Carril bici", "Pas ciclistes"], correcta: 0 },
  { id: "R-12", categoria: "prohibit", pregunta: "Què indica aquest senyal?", tipusSBG: "prohibit", emoji: "🚶", sbg_base: "circulo_rojo_barra", opcions: ["Prohibit vianants", "Pas de vianants", "Zona peatonal"], correcta: 0 },
  { id: "R-13", categoria: "prohibit", pregunta: "Què indica aquest senyal?", tipusSBG: "prohibit", emoji: "🚜", sbg_base: "circulo_rojo_barra", opcions: ["Prohibit tractors", "Zona agrícola", "Prohibit vehicles pesants"], correcta: 0 },
  { id: "R-14", categoria: "prohibit", pregunta: "Què indica aquest senyal?", tipusSBG: "prohibit", emoji: "⚖️", sbg_base: "circulo_rojo_barra", opcions: ["Limitació de pes", "Pes màxim", "Prohibit pesants"], correcta: 0 },
  { id: "R-15", categoria: "prohibit", pregunta: "Què indica aquest senyal?", tipusSBG: "prohibit", emoji: "↔️", sbg_base: "circulo_rojo_barra", opcions: ["Limitació d'amplada", "Amplada màxima", "Estretament"], correcta: 0 },
  { id: "R-16", categoria: "prohibit", pregunta: "Què indica aquest senyal?", tipusSBG: "prohibit", emoji: "↕️", sbg_base: "circulo_rojo_barra", opcions: ["Limitació d'alçada", "Alçada màxima", "Pont baix"], correcta: 0 },
  { id: "R-17", categoria: "prohibit", pregunta: "Què indica aquest senyal?", tipusSBG: "prohibit", emoji: "🅿️", sbg_base: "circulo_rojo_barra", opcions: ["Prohibit aparcar", "Aparcament", "Zona de càrrega"], correcta: 0 },
  { id: "R-18", categoria: "prohibit", pregunta: "Què indica aquest senyal?", tipusSBG: "prohibit", emoji: "⏱️", sbg_base: "circulo_rojo_barra", opcions: ["Prohibit parar i aparcar", "Prohibit aparcar", "Zona de càrrega"], correcta: 0 },
  { id: "R-19", categoria: "prohibit", pregunta: "Quina és la velocitat màxima permesa?", tipusSBG: "text", textSBG: "30", sbg_base: "circulo_rojo_numero", opcions: ["30 km/h", "50 km/h", "80 km/h"], correcta: 0 },
  { id: "R-20", categoria: "prohibit", pregunta: "Què indica aquest senyal?", tipusSBG: "prohibit", emoji: "🔢", sbg_base: "circulo_negro_barra", opcions: ["Final limitació velocitat", "Inici limitació", "Velocitat recomanada"], correcta: 0 },
  { id: "R-21", categoria: "prohibit", pregunta: "Què indica aquest senyal?", tipusSBG: "prohibit", emoji: "📢", sbg_base: "circulo_rojo_barra", opcions: ["Prohibit ús de senyal acústic", "Silenci", "Zona hospitalària"], correcta: 0 },
  { id: "R-22", categoria: "prohibit", pregunta: "Què indica aquest senyal?", tipusSBG: "prohibit", emoji: "☢️", sbg_base: "circulo_rojo_barra", opcions: ["Prohibit mercaderies perilloses", "Zona tòxica", "Prohibit circular"], correcta: 0 },
  { id: "R-23", categoria: "prohibit", pregunta: "Què indica aquest senyal?", tipusSBG: "prohibit", emoji: "💧", sbg_base: "circulo_rojo_barra", opcions: ["Prohibit vehicles amb aigua contaminant", "Prohibit abocar", "Zona protegida"], correcta: 0 },
  { id: "R-24", categoria: "prohibit", pregunta: "Què indica aquest senyal?", tipusSBG: "prohibit", emoji: "💥", sbg_base: "circulo_rojo_barra", opcions: ["Prohibit explosius", "Perill explosió", "Zona segura"], correcta: 0 },
  { id: "R-25", categoria: "prohibit", pregunta: "Què indica aquest senyal?", tipusSBG: "prohibit", emoji: "🚛", sbg_base: "circulo_rojo_barra", opcions: ["Prohibit vehicles > 3,5t", "Pes màxim", "Prohibit camions"], correcta: 0 },
  { id: "R-26", categoria: "prohibit", pregunta: "Què indica aquest senyal?", tipusSBG: "prohibit", emoji: "🚜", sbg_base: "circulo_rojo_barra", opcions: ["Prohibit vehicles agrícoles", "Zona agrícola", "Prohibit tractors"], correcta: 0 },
  { id: "R-27", categoria: "prohibit", pregunta: "Què indica aquest senyal?", tipusSBG: "prohibit", emoji: "🐴", sbg_base: "circulo_rojo_barra", opcions: ["Prohibit tracció animal", "Pas de cavalls", "Zona ramadera"], correcta: 0 },
  { id: "R-28", categoria: "prohibit", pregunta: "Què indica aquest senyal?", tipusSBG: "prohibit", emoji: "🛵", sbg_base: "circulo_rojo_barra", opcions: ["Prohibit ciclomotors", "Prohibit motos", "Prohibit bicis"], correcta: 0 },
  { id: "R-29", categoria: "prohibit", pregunta: "Què indica aquest senyal?", tipusSBG: "prohibit", emoji: "🚴", sbg_base: "circulo_rojo_barra", opcions: ["Prohibit bicicletes", "Carril bici", "Pas ciclistes"], correcta: 0 },
  { id: "R-30", categoria: "prohibit", pregunta: "Quina és la velocitat màxima?", tipusSBG: "text", textSBG: "70", sbg_base: "circulo_rojo_numero", opcions: ["70 km/h", "50 km/h", "90 km/h"], correcta: 0 },

  // ===== 3. SENYALS D'OBLIGACIÓ R-400 A R-418 =====
  { id: "R-400a", categoria: "obligatori", pregunta: "Què indica aquest senyal?", tipusSBG: "obligatori", emoji: "↪️", sbg_base: "circulo_blau", opcions: ["Sentit obligatori dreta", "Gir obligatori", "Desviament"], correcta: 0 },
  { id: "R-400b", categoria: "obligatori", pregunta: "Què indica aquest senyal?", tipusSBG: "obligatori", emoji: "↩️", sbg_base: "circulo_blau", opcions: ["Sentit obligatori esquerra", "Gir obligatori", "Desviament"], correcta: 0 },
  { id: "R-400c", categoria: "obligatori", pregunta: "Què indica aquest senyal?", tipusSBG: "obligatori", emoji: "⬆️", sbg_base: "circulo_blau", opcions: ["Sentit obligatori recte", "Direcció única", "Prohibit girar"], correcta: 0 },
  { id: "R-400d", categoria: "obligatori", pregunta: "Què indica aquest senyal?", tipusSBG: "obligatori", emoji: "⬆️↪️", sbg_base: "circulo_blau", opcions: ["Sentit obligatori recte o dreta", "Gir obligatori", "Direcció única"], correcta: 0 },
  { id: "R-400e", categoria: "obligatori", pregunta: "Què indica aquest senyal?", tipusSBG: "obligatori", emoji: "⬆️↩️", sbg_base: "circulo_blau", opcions: ["Sentit obligatori recte o esquerra", "Gir obligatori", "Direcció única"], correcta: 0 },
  { id: "R-401a", categoria: "obligatori", pregunta: "Què indica aquest senyal?", tipusSBG: "obligatori", emoji: "↪️", sbg_base: "circulo_blau", opcions: ["Pas obligatori per la dreta", "Gir obligatori", "Desviament"], correcta: 0 },
  { id: "R-401b", categoria: "obligatori", pregunta: "Què indica aquest senyal?", tipusSBG: "obligatori", emoji: "↩️", sbg_base: "circulo_blau", opcions: ["Pas obligatori per l'esquerra", "Gir obligatori", "Desviament"], correcta: 0 },
  { id: "R-402", categoria: "obligatori", pregunta: "Què indica aquest senyal?", tipusSBG: "obligatori", emoji: "🔄", sbg_base: "circulo_blau", opcions: ["Intersecció de sentit giratori", "Rotonda", "Prohibit girar"], correcta: 0 },
  { id: "R-403a", categoria: "obligatori", pregunta: "Què indica aquest senyal?", tipusSBG: "obligatori", emoji: "🚌", sbg_base: "circulo_blau", opcions: ["Carril bus", "Parada bus", "Prohibit bus"], correcta: 0 },
  { id: "R-404", categoria: "obligatori", pregunta: "Què indica aquest senyal?", tipusSBG: "obligatori", emoji: "🚴", sbg_base: "circulo_blau", opcions: ["Carril bici", "Prohibit bicis", "Pas ciclistes"], correcta: 0 },
  { id: "R-405", categoria: "obligatori", pregunta: "Què indica aquest senyal?", tipusSBG: "obligatori", emoji: "🚶", sbg_base: "circulo_blau", opcions: ["Camí per a vianants", "Pas de vianants", "Zona peatonal"], correcta: 0 },
  { id: "R-406", categoria: "obligatori", pregunta: "Què indica aquest senyal?", tipusSBG: "obligatori", emoji: "🐴", sbg_base: "circulo_blau", opcions: ["Camí per a genets", "Pas de cavalls", "Zona ramadera"], correcta: 0 },
  { id: "R-407", categoria: "obligatori", pregunta: "Quina és la velocitat mínima?", tipusSBG: "text", textSBG: "80", sbg_base: "circulo_blau_numero", opcions: ["80 km/h", "60 km/h", "100 km/h"], correcta: 0 },
  { id: "R-408", categoria: "obligatori", pregunta: "Què indica aquest senyal?", tipusSBG: "obligatori", emoji: "⛓️", sbg_base: "circulo_blau", opcions: ["Ús obligatori de cadenes", "Neu", "Perill"], correcta: 0 },
  { id: "R-409", categoria: "obligatori", pregunta: "Què indica aquest senyal?", tipusSBG: "obligatori", emoji: "💡", sbg_base: "circulo_blau", opcions: ["Ús obligatori llums", "Encreuament", "Túnel"], correcta: 0 },
  { id: "R-410", categoria: "obligatori", pregunta: "Què indica aquest senyal?", tipusSBG: "obligatori", emoji: "📢", sbg_base: "circulo_blau", opcions: ["Ús obligatori clàxon", "Perill", "Zona escolar"], correcta: 0 },
  { id: "R-411", categoria: "obligatori", pregunta: "Què indica aquest senyal?", tipusSBG: "obligatori", emoji: "🦺", sbg_base: "circulo_blau", opcions: ["Ús obligatori cinturó", "Seguretat", "Prohibit"], correcta: 0 },
  { id: "R-412", categoria: "obligatori", pregunta: "Què indica aquest senyal?", tipusSBG: "obligatori", emoji: "⛑️", sbg_base: "circulo_blau", opcions: ["Ús obligatori casc", "Seguretat", "Obres"], correcta: 0 },
  { id: "R-413", categoria: "obligatori", pregunta: "Què indica aquest senyal?", tipusSBG: "obligatori", emoji: "🦺", sbg_base: "circulo_blau", opcions: ["Ús obligatori armilla", "Seguretat", "Obres"], correcta: 0 },
  { id: "R-414", categoria: "obligatori", pregunta: "Què indica aquest senyal?", tipusSBG: "obligatori", emoji: "🧯", sbg_base: "circulo_blau", opcions: ["Ús obligatori extintor", "Perill incendi", "Seguretat"], correcta: 0 },

  // ===== 4. SENYALS D'INFORMACIÓ S-1 A S-30 =====
  { id: "S-1", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "informacio", emoji: "🛣️", sbg_base: "quadrat_blau", opcions: ["Autopista", "Autovia", "Carretera"], correcta: 0 },
  { id: "S-2", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "informacio", emoji: "🛣️", sbg_base: "quadrat_blau", opcions: ["Final autopista", "Inici autopista", "Desviament"], correcta: 0 },
  { id: "S-3", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "informacio", emoji: "🛣️", sbg_base: "quadrat_blau", opcions: ["Autovia", "Autopista", "Carretera"], correcta: 0 },
  { id: "S-4", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "informacio", emoji: "🛣️", sbg_base: "quadrat_blau", opcions: ["Final autovia", "Inici autovia", "Desviament"], correcta: 0 },
  { id: "S-5", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "informacio", emoji: "🚇", sbg_base: "quadrat_blau", opcions: ["Túnel", "Pas inferior", "Obres"], correcta: 0 },
  { id: "S-6", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "informacio", emoji: "⬇️", sbg_base: "quadrat_blau", opcions: ["Pas inferior", "Túnel", "Desnivell"], correcta: 0 },
  { id: "S-7", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "informacio", emoji: "⬆️", sbg_base: "quadrat_blau", opcions: ["Pas superior", "Pont", "Desnivell"], correcta: 0 },
  { id: "S-8", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "informacio", emoji: "🚫", sbg_base: "quadrat_blau", opcions: ["Carretera sense sortida", "Prohibit", "Fi de via"], correcta: 0 },
  { id: "S-9", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "informacio", emoji: "📍", sbg_base: "quadrat_blau", opcions: ["Direccions", "Itinerari", "Localitat"], correcta: 0 },
  { id: "S-10", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "text", textSBG: "GIRONA", sbg_base: "quadrat_blau", opcions: ["Itinerari", "Localitat", "Sortida"], correcta: 0 },
  { id: "S-11", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "text", textSBG: "BARCELONA", sbg_base: "quadrat_blau", opcions: ["Localitat", "Itinerari", "Província"], correcta: 0 },
  { id: "S-12", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "informacio", emoji: "✈️", sbg_base: "quadrat_blau", opcions: ["Aeroport", "Avió", "Transport"], correcta: 0 },
  { id: "S-13a", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "informacio", emoji: "🚶", sbg_base: "quadrat_blau", opcions: ["Pas de vianants", "Zona escolar", "Prohibit vianants"], correcta: 0 },
  { id: "S-13b", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "informacio", emoji: "🚶", sbg_base: "quadrat_blau", opcions: ["Pas elevat", "Pas de vianants", "Pont"], correcta: 0 },
  { id: "S-14", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "informacio", emoji: "🏥", sbg_base: "quadrat_blau", opcions: ["Hospital", "Farmàcia", "Centre mèdic"], correcta: 0 },
  { id: "S-15", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "informacio", emoji: "📞", sbg_base: "quadrat_blau", opcions: ["Telèfon", "Trucar", "Emergència"], correcta: 0 },
  { id: "S-16", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "informacio", emoji: "🔧", sbg_base: "quadrat_blau", opcions: ["Taller", "Mecànic", "Reparació"], correcta: 0 },
  { id: "S-17", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "informacio", emoji: "⛽", sbg_base: "quadrat_blau", opcions: ["Estació de servei", "Gasolina", "Taller"], correcta: 0 },
  { id: "S-18", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "text", textSBG: "HOTEL", sbg_base: "quadrat_blau", opcions: ["Hotel", "Allotjament", "Descans"], correcta: 0 },
  { id: "S-19", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "text", textSBG: "REST", sbg_base: "quadrat_blau", opcions: ["Restaurant", "Menjar", "Bar"], correcta: 0 },
  { id: "S-20", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "informacio", emoji: "⛺", sbg_base: "quadrat_blau", opcions: ["Càmping", "Acampada", "Descans"], correcta: 0 },
  { id: "S-21", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "informacio", emoji: "🏖️", sbg_base: "quadrat_blau", opcions: ["Platja", "Mar", "Bany"], correcta: 0 },
  { id: "S-22", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "informacio", emoji: "🚸", sbg_base: "quadrat_blau", opcions: ["Zona escolar", "Nens", "Prohibit"], correcta: 0 },
{ id: "S-23", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "informacio", emoji: "🏞️", sbg_base: "quadrat_blau", opcions: ["Parc natural", "Zona verda", "Descans"], correcta: 0 },
{ id: "S-24", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "informacio", emoji: "🚻", sbg_base: "quadrat_blau", opcions: ["Serveis", "WC", "Bany"], correcta: 0 },
{ id: "S-25", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "informacio", emoji: "📍", sbg_base: "quadrat_blau", opcions: ["Informació", "Punt d'informació", "Turisme"], correcta: 0 },
{ id: "S-26", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "informacio", emoji: "🅿️", sbg_base: "quadrat_blau", opcions: ["Aparcament", "Prohibit aparcar", "Zona de càrrega"], correcta: 0 },
{ id: "S-27", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "informacio", emoji: "🛑", sbg_base: "quadrat_blau", opcions: ["Parada bus", "Bus", "Transport públic"], correcta: 0 },
{ id: "S-28", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "informacio", emoji: "🚖", sbg_base: "quadrat_blau", opcions: ["Parada taxi", "Taxi", "Transport"], correcta: 0 },
{ id: "S-29", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "informacio", emoji: "🚑", sbg_base: "quadrat_blau", opcions: ["Ambulància", "Emergència", "Hospital"], correcta: 0 },
{ id: "S-30", categoria: "informacio", pregunta: "Què indica aquest senyal?", tipusSBG: "informacio", emoji: "⛪", sbg_base: "quadrat_blau", opcions: ["Lloc d'interès", "Monument", "Turisme"], correcta: 0 },

  // ===== 5. SENYALS D'OBRES / ESPECIALS =====
{ id: "S-510", categoria: "obres", pregunta: "Què indica aquest senyal?", tipusSBG: "obres", emoji: "🚧", sbg_base: "triangulo_groc", opcions: ["Obres", "Desviament", "Perill"], correcta: 0 },
{ id: "S-511", categoria: "obres", pregunta: "Què indica aquest senyal?", tipusSBG: "obres", emoji: "🚧", sbg_base: "triangulo_groc", opcions: ["Desviament", "Obres", "Direcció"], correcta: 0 },
{ id: "S-512", categoria: "obres", pregunta: "Què indica aquest senyal?", tipusSBG: "obres", emoji: "↔️", sbg_base: "triangulo_groc", opcions: ["Estretament per obres", "Obres", "Perill"], correcta: 0 },
{ id: "S-513", categoria: "obres", pregunta: "Què indica aquest senyal?", tipusSBG: "obres", emoji: "🚦", sbg_base: "triangulo_groc", opcions: ["Semàfor per obres", "Obres", "Perill"], correcta: 0 },
{ id: "S-514", categoria: "obres", pregunta: "Què indica aquest senyal?", tipusSBG: "obres", emoji: "👷", sbg_base: "triangulo_groc", opcions: ["Treballadors", "Obres", "Perill"], correcta: 0 },
{ id: "R-101", categoria: "fi_prohibicio", pregunta: "Què indica aquest senyal?", tipusSBG: "fi_prohibicio", emoji: "🔚", sbg_base: "circulo_blanc_barra_negra", opcions: ["Fi de totes les prohibicions", "Fi limitació", "Fi zona"], correcta: 0 },
{ id: "R-500", categoria: "fi_prohibicio", pregunta: "Què indica aquest senyal?", tipusSBG: "fi_prohibicio", emoji: "🏁", sbg_base: "circulo_blanc_barra_negra", opcions: ["Fi limitació velocitat", "Velocitat lliure", "Fi zona 30"], correcta: 0 },
{ id: "R-501", categoria: "fi_prohibicio", pregunta: "Què indica aquest senyal?", tipusSBG: "fi_prohibicio", emoji: "🚫", sbg_base: "circulo_blanc_barra_negra", opcions: ["Fi prohibit avançar", "Fi prohibició", "Velocitat lliure"], correcta: 0 }
],
