...
mecanica: [
  // ===== M-01_MOTOR_BASIC.jpg =====
  { id: "M-01-01", panel_id: "M-01", ruta_panel: "M-01_MOTOR_BASIC.jpg", categoria: "MECANICA", pictograma: "MOTOR", pregunta: "Què és el motor de combustió?", opciones: ["Converteix combustible en moviment", "Filtra l'aire", "Refreda el líquid"], correcta: 0, explicacion: "El motor crema la mescla aire-combustible per generar moviment. És el cor del vehicle.", tip: "El motor crema la mescla aire-combustible per generar moviment. És el cor del vehicle." },
  { id: "M-01-02", panel_id: "M-01", ruta_panel: "M-01_MOTOR_BASIC.jpg", categoria: "MECANICA", pictograma: "PISTON", pregunta: "Què fa el pistó dins del cilindre?", opciones: ["Puja i baixa comprimint la mescla", "Filtra l'oli", "Carrega la bateria"], correcta: 0, explicacion: "El pistó comprimeix la mescla i transmet la força de l'explosió al cigonyal.", tip: "El pistó comprimeix la mescla i transmet la força al cigonyal." },
  { id: "M-01-03", panel_id: "M-01", ruta_panel: "M-01_MOTOR_BASIC.jpg", categoria: "MECANICA", pictograma: "ACEITE", pregunta: "Per a què serveix l'oli del motor?", opciones: ["Lubricar, netejar i refrigerar peces", "Només per donar color", "Per frenar"], correcta: 0, explicacion: "L'oli redueix el fregament, neteja residus i ajuda a evacuar calor.", tip: "L'oli redueix fregament, neteja i refrigera." },
  { id: "M-01-04", panel_id: "M-01", ruta_panel: "M-01_MOTOR_BASIC.jpg", categoria: "MECANICA", pictograma: "REFRIGERACION", pregunta: "Si el testimoni de temperatura s'encén en vermell, què has de fer?", opciones: ["Aturar-te al més aviat possible en lloc segur i parar motor", "Accelerar per refredar", "Seguir circulant"], correcta: 0, explicacion: "Sobrecalentament greu. Parar motor per evitar gripatge.", tip: "Sobrecalentament greu. Atura't i para el motor." },
  { id: "M-01-05", panel_id: "M-01", ruta_panel: "M-01_MOTOR_BASIC.jpg", categoria: "MECANICA", pictograma: "TERMOSTATO", pregunta: "Quina funció té el termòstat?", opciones: ["Regular la temperatura deixant passar refrigerant al radiador", "Carregar la bateria", "Filtrar gasoil"], correcta: 0, explicacion: "Tanca el pas en fred per escalfar ràpid i obre quan arriba a temperatura òptima.", tip: "Tanca en fred, obre en calent per regular temperatura." },
  { id: "M-01-06", panel_id: "M-01", ruta_panel: "M-01_MOTOR_BASIC.jpg", categoria: "MECANICA", pictograma: "FILTRO_ACEITE", pregunta: "Cada quant es revisa el nivell d'oli?", opciones: ["Regularment amb motor fred i en pla", "Només a la ITV", "Mai"], correcta: 0, explicacion: "Revisió visual amb vareta, motor fred i vehicle horitzontal.", tip: "Motor fred, en pla, entre mín i màx." },

  // ===== M-02_FRENOS_RUEDAS.jpg =====
  { id: "M-02-01", panel_id: "M-02", ruta_panel: "M-02_FRENOS_RUEDAS.jpg", categoria: "MECANICA", pictograma: "FRENO", pregunta: "Quin element crea la fricció per frenar?", opciones: ["Pastilles contra disc", "L'oli", "El filtre d'aire"], correcta: 0, explicacion: "La pinça prem les pastilles contra el disc i genera fricció.", tip: "Pastilles contra disc = fricció = frenada." },
  { id: "M-02-02", panel_id: "M-02", ruta_panel: "M-02_FRENOS_RUEDAS.jpg", categoria: "MECANICA", pictograma: "PASTILLAS", pregunta: "Com notes el desgast de pastilles?", opciones: ["Soroll agut en frenar i més distància", "El motor sona més", "El volant vibra sol"], correcta: 0, explicacion: "Xerric metàl·lic i pedal més llarg indiquen desgast.", tip: "Xerric metàl·lic = pastilles gastades." },
  { id: "M-02-03", panel_id: "M-02", ruta_panel: "M-02_FRENOS_RUEDAS.jpg", categoria: "MECANICA", pictograma: "ABS", pregunta: "Per a què serveix l'ABS?", opciones: ["Evitar bloqueig de rodes i mantenir direcció en frenada forta", "Augmentar velocitat", "Estalviar combustible"], correcta: 0, explicacion: "L'ABS modula pressió per no bloquejar i poder girar.", tip: "ABS evita bloqueig i et deixa girar mentre frenes." },
  { id: "M-02-04", panel_id: "M-02", ruta_panel: "M-02_FRENOS_RUEDAS.jpg", categoria: "MECANICA", pictograma: "NEUMATICO", pregunta: "Quin és el dibuix mínim legal del pneumàtic?", opciones: ["1,6 mm de profunditat", "0,2 mm", "5 mm"], correcta: 0, explicacion: "Mínim 1,6 mm. Per sota perd adherència, sobretot en mullat.", tip: "Mínim legal 1,6 mm. En mullat és crític." },
  { id: "M-02-05", panel_id: "M-02", ruta_panel: "M-02_FRENOS_RUEDAS.jpg", categoria: "MECANICA", pictograma: "SUSPENSION", pregunta: "Què fa la suspensió?", opciones: ["Mantenir contacte roda-sòl i confort", "Carregar bateria", "Filtrar gasoil"], correcta: 0, explicacion: "Es mortifica els sots i manté l'estabilitat.", tip: "Suspensió = contacte amb el sòl + estabilitat." },
  { id: "M-02-06", panel_id: "M-02", ruta_panel: "M-02_FRENOS_RUEDAS.jpg", categoria: "MECANICA", pictograma: "DIRECCION", pregunta: "Què és la direcció assistida?", opciones: ["Sistema que ajuda a girar el volant amb menys esforç", "Un tipus de fre", "Un filtre"], correcta: 0, explicacion: "Hidràulica o elèctrica, facilita el gir, sobretot en aturat.", tip: "T'ajuda a girar, sobretot en maniobra." },

  // ===== M-03_ELECTRICO_ARRANQUE.jpg =====
  { id: "M-03-01", panel_id: "M-03", ruta_panel: "M-03_ELECTRICO_ARRANQUE.jpg", categoria: "MECANICA", pictograma: "BATERIA", pregunta: "Què fa la bateria de 12V?", opciones: ["Alimentar arrencada i sistemes amb motor parat", "Filtrar oli", "Refredar motor"], correcta: 0, explicacion: "Emmagatzema energia per a arrencada, llums i electrònica.", tip: "12V per arrencar i alimentar electrònica." },
  { id: "M-03-02", panel_id: "M-03", ruta_panel: "M-03_ELECTRICO_ARRANQUE.jpg", categoria: "MECANICA", pictograma: "ALTERNADOR", pregunta: "Què fa l'alternador?", opciones: ["Carregar la bateria amb motor en marxa", "Frenar el cotxe", "Filtrar aire"], correcta: 0, explicacion: "Converteix energia del motor en electricitat per carregar bateria.", tip: "Amb motor en marxa, carrega la bateria." },
  { id: "M-03-03", panel_id: "M-03", ruta_panel: "M-03_ELECTRICO_ARRANQUE.jpg", categoria: "MECANICA", pictograma: "ARRANQUE", pregunta: "Què fa el motor d'arrencada?", opciones: ["Fer girar el motor per arrencar", "Refredar radiador", "Obrir portes"], correcta: 0, explicacion: "Petit motor elèctric que inicia el gir del motor tèrmic.", tip: "Inicia el gir del motor tèrmic." },
  { id: "M-03-04", panel_id: "M-03", ruta_panel: "M-03_ELECTRICO_ARRANQUE.jpg", categoria: "MECANICA", pictograma: "BUJIA", pregunta: "En quin motor hi ha bugies?", opciones: ["En gasolina, creen espurna", "Només en dièsel", "En cap"], correcta: 0, explicacion: "Gasolina: bugia genera espurna. Dièsel usa escalfadors.", tip: "Gasolina = espurna. Dièsel = escalfadors." },
  { id: "M-03-05", panel_id: "M-03", ruta_panel: "M-03_ELECTRICO_ARRANQUE.jpg", categoria: "MECANICA", pictograma: "CORREA", pregunta: "Si xerrica la corretja d'accessoris, què indica?", opciones: ["Desgast o destensat", "Falta de gasoil", "Fre gastat"], correcta: 0, explicacion: "Xerric = corretja patina, revisar tensió i estat.", tip: "Xerric = patina. Revisa tensió." },
  { id: "M-03-06", panel_id: "M-03", ruta_panel: "M-03_ELECTRICO_ARRANQUE.jpg", categoria: "MECANICA", pictograma: "CHASIS", pregunta: "Què és el bastidor o xassís?", opciones: ["Estructura que suporta tot el vehicle", "Un filtre", "Un fusible"], correcta: 0, explicacion: "Base rígida on es fixa motor, carrosseria i resta.", tip: "Xassís = esquelet del vehicle." },

  // ===== M-04_TRANSMISION.jpg =====
  { id: "M-04-01", panel_id: "M-04", ruta_panel: "M-04_TRANSMISION.jpg", categoria: "MECANICA", pictograma: "EMBRAGUE", pregunta: "Per a què serveix l'embragatge?", opciones: ["Separar motor de caixa per canviar marxa", "Frenar", "Refredar"], correcta: 0, explicacion: "Desacobra motor i transmissió per canviar sense forçar.", tip: "Desacobra motor i caixa per canviar." },
  { id: "M-04-02", panel_id: "M-04", ruta_panel: "M-04_TRANSMISION.jpg", categoria: "MECANICA", pictograma: "CAJA_CAMBIOS", pregunta: "Què permet la caixa de canvis?", opciones: ["Adaptar parell i velocitat a la marxa", "Carregar bateria", "Filtrar oli"], correcta: 0, explicacion: "Multiplica força en marxes curtes i velocitat en llargues.", tip: "Curtes = força, llargues = velocitat." },
  { id: "M-04-03", panel_id: "M-04", ruta_panel: "M-04_TRANSMISION.jpg", categoria: "MECANICA", pictograma: "PALIER", pregunta: "Què és el palier?", opciones: ["Eix que porta gir del diferencial a la roda", "Filtre d'aire", "Bomba d'aigua"], correcta: 0, explicacion: "Transmet tracció final a cada roda motriu.", tip: "Palier = últim eix cap a la roda." },
  { id: "M-04-04", panel_id: "M-04", ruta_panel: "M-04_TRANSMISION.jpg", categoria: "MECANICA", pictograma: "DIFERENCIAL", pregunta: "Què permet el diferencial en corba?", opciones: ["Que rodes del mateix eix girin a diferent velocitat", "Que frenin igual", "Que s'aturi el motor"], correcta: 0, explicacion: "Roda exterior recorre més distància, necessita girar més ràpid.", tip: "En corba, roda exterior gira més ràpid." },
  { id: "M-04-05", panel_id: "M-04", ruta_panel: "M-04_TRANSMISION.jpg", categoria: "MECANICA", pictograma: "GRUPO_CONICO", pregunta: "Què fa el grup cònic?", opciones: ["Canviar gir 90 graus cap a rodes", "Filtrar gasoil", "Carregar bateria"], correcta: 0, explicacion: "En tracció darrere canvia direcció de gir del cardan.", tip: "Canvia gir 90º cap a rodes del darrere." },
  { id: "M-04-06", panel_id: "M-04", ruta_panel: "M-04_TRANSMISION.jpg", categoria: "MECANICA", pictograma: "CARDAN", pregunta: "Què uneix l'arbre cardan?", opciones: ["Caixa de canvis amb diferencial del darrere", "Bateria amb alternador", "Radiador amb motor"], correcta: 0, explicacion: "Transmet gir a llarga distància en propulsió del darrere.", tip: "Uneix caixa amb diferencial darrere." },

  // ===== M-05_REFRIGERACION.jpg =====
  { id: "M-05-01", panel_id: "M-05", ruta_panel: "M-05_REFRIGERACION.jpg", categoria: "MECANICA", pictograma: "BOMBA_AGUA", pregunta: "Què mou la bomba d'aigua?", opciones: ["Fa circular refrigerant pel circuit", "Bombeja oli", "Bombeja gasoil"], correcta: 0, explicacion: "Circula líquid per motor i radiador.", tip: "Circula refrigerant per tot el circuit." },
  { id: "M-05-02", panel_id: "M-05", ruta_panel: "M-05_REFRIGERACION.jpg", categoria: "MECANICA", pictograma: "RADIADOR", pregunta: "Què fa el radiador?", opciones: ["Dissipa calor del refrigerant a l'aire", "Filtra aire", "Carrega bateria"], correcta: 0, explicacion: "Intercanviador aire-líquid que refreda.", tip: "Radiador = intercanviador que refreda." },
  { id: "M-05-03", panel_id: "M-05", ruta_panel: "M-05_REFRIGERACION.jpg", categoria: "MECANICA", pictograma: "VENTILADOR", pregunta: "Quan actua l'electroventilador?", opciones: ["Quan l'aire natural no basta, sobretot aturat", "Sempre a tope", "Només a autopista"], correcta: 0, explicacion: "S'activa per temperatura per forçar aire per radiador.", tip: "S'activa quan el cotxe està aturat i fa calor." },
  { id: "M-05-04", panel_id: "M-05", ruta_panel: "M-05_REFRIGERACION.jpg", categoria: "MECANICA", pictograma: "DEPOSITO_EXPANSION", pregunta: "Per a què és el dipòsit d'expansió?", opciones: ["Recollir expansió del líquid i mantenir nivell", "Guardar oli", "Guardar gasoil"], correcta: 0, explicacion: "Compensa dilatació i permet omplir circuit.", tip: "Compensa dilatació del refrigerant." },
  { id: "M-05-05", panel_id: "M-05", ruta_panel: "M-05_REFRIGERACION.jpg", categoria: "MECANICA", pictograma: "MANGUITO", pregunta: "Si un maneguet perd líquid, què passa?", opciones: ["Baixa nivell i risc de sobreescalfament", "Millora frenada", "Augmenta càrrega bateria"], correcta: 0, explicacion: "Fuga = pèrdua refrigeració = perill gripatge.", tip: "Fuga = risc de gripatge." },
  { id: "M-05-06", panel_id: "M-05", ruta_panel: "M-05_REFRIGERACION.jpg", categoria: "MECANICA", pictograma: "ANTICONGELANTE", pregunta: "Quin avantatge té l'anticongelant?", opciones: ["No es congela a l'hivern i no bull tan fàcil a l'estiu", "Només dóna color", "Augmenta consum"], correcta: 0, explicacion: "Mescla aigua + glicol protegeix -30ºC a +120ºC i anticorrosió.", tip: "Protegeix de -30 a +120 i evita corrosió." },

  // ===== M-06_FILTROS_TURBO.jpg =====
  { id: "M-06-01", panel_id: "M-06", ruta_panel: "M-06_FILTROS_TURBO.jpg", categoria: "MECANICA", pictograma: "VARILLA_ACEITE", pregunta: "Com es mesura el nivell d'oli correctament?", opciones: ["Motor fred, pla, treure vareta, netejar i mesurar", "Amb motor engegat", "En pendent"], correcta: 0, explicacion: "Mesura fiable en fred i horitzontal entre mín i màx.", tip: "Fred, pla, neteja vareta i mesura." },
  { id: "M-06-02", panel_id: "M-06", ruta_panel: "M-06_FILTROS_TURBO.jpg", categoria: "MECANICA", pictograma: "FILTRO_ACEITE", pregunta: "Què reté el filtre d'oli?", opciones: ["Impureses metàl·liques i brutícia", "Aigua del radiador", "Aire"], correcta: 0, explicacion: "Protegeix motor de partícules abrasives.", tip: "Reté partícules metàl·liques." },
  { id: "M-06-03", panel_id: "M-06", ruta_panel: "M-06_FILTROS_TURBO.jpg", categoria: "MECANICA", pictograma: "FILTRO_AIRE", pregunta: "Què passa si el filtre d'aire està molt brut?", opciones: ["Més consum i menys potència", "Frena millor", "Carrega més bateria"], correcta: 0, explicacion: "Menys aire = combustió incompleta.", tip: "Filtre brut = més consum i menys potència." },
  { id: "M-06-04", panel_id: "M-06", ruta_panel: "M-06_FILTROS_TURBO.jpg", categoria: "MECANICA", pictograma: "FILTRO_GASOIL", pregunta: "Què filtra el filtre de gasoil?", opciones: ["Aigua i impureses del dièsel", "Oli del motor", "Líquid de frens"], correcta: 0, explicacion: "Evita que aigua/impureses danyin bomba i injectors.", tip: "Filtra aigua i brutícia del dièsel." },
  { id: "M-06-05", panel_id: "M-06", ruta_panel: "M-06_FILTROS_TURBO.jpg", categoria: "MECANICA", pictograma: "TURBO", pregunta: "Què fa el turbo?", opciones: ["Aprofita gasos escapament per ficar més aire al motor", "Refreda radiador", "Filtra oli"], correcta: 0, explicacion: "Més aire = més potència sense augmentar cilindrada.", tip: "Més aire = més potència." },
  { id: "M-06-06", panel_id: "M-06", ruta_panel: "M-06_FILTROS_TURBO.jpg", categoria: "MECANICA", pictograma: "INTERCOOLER", pregunta: "Què fa l'intercooler?", opciones: ["Refreda aire del turbo abans d'entrar al motor", "Escalfa gasoil", "Carrega bateria"], correcta: 0, explicacion: "Aire més fred = més dens = millor combustió.", tip: "Refreda aire del turbo per millor combustió." },

  // ===== M-07_HIBRIDO_TECH.jpg =====
  { id: "M-07-01", panel_id: "M-07", ruta_panel: "M-07_HIBRIDO_TECH.jpg", categoria: "MECANICA", pictograma: "MOTOR_ELECTRICO", pregunta: "Com funciona un híbrid?", opciones: ["Combina motor tèrmic i elèctric per eficiència", "Només amb gasolina", "Només amb dièsel"], correcta: 0, explicacion: "Elèctric a ciutat, tèrmic a carretera, tots dos si cal.", tip: "Híbrid: elèctric a ciutat, tèrmic a carretera." },
  { id: "M-07-02", panel_id: "M-07", ruta_panel: "M-07_HIBRIDO_TECH.jpg", categoria: "MECANICA", pictograma: "BATERIA_LITIO", pregunta: "On és la bateria d'alt voltatge en híbrid?", opciones: ["Normalment sota seient del darrere o maleter, aïllada", "Al radiador", "A l'escapament"], correcta: 0, explicacion: "Bateria HV de 200-400V, no confondre amb 12V.", tip: "HV 200-400V sota seient/maleter." },
  { id: "M-07-03", panel_id: "M-07", ruta_panel: "M-07_HIBRIDO_TECH.jpg", categoria: "MECANICA", pictograma: "FRENO_REGENERATIVO", pregunta: "Què és el fre regeneratiu?", opciones: ["Recupera energia en frenar per recarregar bateria", "Frena amb aire", "Només fre de mà"], correcta: 0, explicacion: "Motor elèctric actua com a generador en desaccelerar.", tip: "En frenar, recarrega bateria." },
  { id: "M-07-04", panel_id: "M-07", ruta_panel: "M-07_HIBRIDO_TECH.jpg", categoria: "MECANICA", pictograma: "ESP", pregunta: "Què fa l'ESP?", opciones: ["Corregeix trajectòria si detecta derrapada", "Augmenta velocitat", "Filtra gasoil"], correcta: 0, explicacion: "Frena roda individual i talla potència per estabilitzar.", tip: "ESP = estabilitza frenant roda." },
  { id: "M-07-05", panel_id: "M-07", ruta_panel: "M-07_HIBRIDO_TECH.jpg", categoria: "MECANICA", pictograma: "EBS", pregunta: "Què és EBS en camió?", opciones: ["Frenada electrònica que gestiona tots els frens", "Un filtre", "Un tipus d'oli"], correcta: 0, explicacion: "Electronic Braking System, frenada més ràpida i estable en pesats.", tip: "EBS = frenada electrònica en camions." },
  { id: "M-07-06", panel_id: "M-07", ruta_panel: "M-07_HIBRIDO_TECH.jpg", categoria: "MECANICA", pictograma: "BAS", pregunta: "Què fa el BAS?", opciones: ["Detecta frenada d'emergència i aplica màxima força", "Carrega bateria", "Refreda motor"], correcta: 0, explicacion: "Brake Assist System ajuda si conductor no trepitja prou fort.", tip: "BAS = ajuda en frenada d'emergència." },

  // ===== M-08_AVERIAS_HUMOS.jpg =====
  { id: "M-08-01", panel_id: "M-08", ruta_panel: "M-08_AVERIAS_HUMOS.jpg", categoria: "MECANICA", pictograma: "HUMO_BLANCO", pregunta: "Què indica fum blanc espès continu?", opciones: ["Possible junta culata, entra refrigerant al cilindre", "Normal en dièsel fred uns segons", "Falta oli"], correcta: 0, explicacion: "Blanc dens = aigua/refrigerant cremat. Revisar urgent.", tip: "Blanc dens continu = possible junta culata." },
  { id: "M-08-02", panel_id: "M-08", ruta_panel: "M-08_AVERIAS_HUMOS.jpg", categoria: "MECANICA", pictograma: "HUMO_NEGRO", pregunta: "Què indica fum negre en dièsel?", opciones: ["Excés gasoil, combustió incompleta, filtre aire brut", "Falta aigua", "Bateria baixa"], correcta: 0, explicacion: "Mescla rica o filtre aire obstruït.", tip: "Negre = excés gasoil o filtre aire brut." },
  { id: "M-08-03", panel_id: "M-08", ruta_panel: "M-08_AVERIAS_HUMOS.jpg", categoria: "MECANICA", pictograma: "HUMO_AZUL", pregunta: "Què indica fum blau?", opciones: ["Motor crema oli", "Motor crema aigua", "Normal"], correcta: 0, explicacion: "Blau = oli en combustió per desgast segments o retenidors.", tip: "Blau = crema oli." },
  { id: "M-08-04", panel_id: "M-08", ruta_panel: "M-08_AVERIAS_HUMOS.jpg", categoria: "MECANICA", pictograma: "SOBRECALENTAMIENTO", pregunta: "Què fer si s'encén testimoni de sobreescalfament?", opciones: ["Aturar, apagar, esperar i no obrir radiador en calent", "Obrir radiador de seguida", "Seguir a 120"], correcta: 0, explicacion: "Obrir en calent crema per vapor a pressió.", tip: "Mai obris radiador en calent. Crema!" },
  { id: "M-08-05", panel_id: "M-08", ruta_panel: "M-08_AVERIAS_HUMOS.jpg", categoria: "MECANICA", pictograma: "CHIRRIDO_CORREA", pregunta: "Què indica xerric en arrencar en fred?", opciones: ["Corretja destensada o desgastada", "Fre de mà posat", "Falta gasoil"], correcta: 0, explicacion: "Corretja patina fins que agafa temperatura.", tip: "Xerric en fred = corretja destensada." },
  { id: "M-08-06", panel_id: "M-08", ruta_panel: "M-08_AVERIAS_HUMOS.jpg", categoria: "MECANICA", pictograma: "FUGA_LIQUIDO", pregunta: "Taca verda/rosa sota el motor?", opciones: ["Possible fuga refrigerant", "Fuga d'oli motor", "Normal"], correcta: 0, explicacion: "Refrigerant sol ser verd, rosa o taronja.", tip: "Taca verda/rosa = refrigerant." },

  // ===== M-09_CAMION_INDUSTRIAL.jpg =====
  { id: "M-09-01", panel_id: "M-09", ruta_panel: "M-09_CAMION_INDUSTRIAL.jpg", categoria: "MECANICA", pictograma: "CABEZA_TRACTORA", pregunta: "Què és la cap tractora?", opciones: ["Vehicle que arrossega semiremolc", "Un remolc sense motor", "Un filtre"], correcta: 0, explicacion: "Tractora + semiremolc = articulat.", tip: "Tractora + semiremolc = articulat." },
  { id: "M-09-02", panel_id: "M-09", ruta_panel: "M-09_CAMION_INDUSTRIAL.jpg", categoria: "MECANICA", pictograma: "REMOLQUE", pregunta: "Quina diferència hi ha entre remolc i semiremolc?", opciones: ["Remolc recolza tot el seu pes als seus eixos, semiremolc part a la tractora", "Són iguals", "Remolc no té rodes"], correcta: 0, explicacion: "Semiremolc transmet pes a cinquena roda.", tip: "Semiremolc transmet pes a la tractora." },
  { id: "M-09-03", panel_id: "M-09", ruta_panel: "M-09_CAMION_INDUSTRIAL.jpg", categoria: "MECANICA", pictograma: "QUINTA_RUEDA", pregunta: "Què és la cinquena roda?", opciones: ["Acoblament entre tractora i semiremolc", "Roda de recanvi", "Fre extra"], correcta: 0, explicacion: "Plat que enganxa kingpin del semiremolc.", tip: "Cinquena roda = enganxall del semiremolc." },
  { id: "M-09-04", panel_id: "M-09", ruta_panel: "M-09_CAMION_INDUSTRIAL.jpg", categoria: "MECANICA", pictograma: "EJE_TANDEM", pregunta: "Què és eix tàndem?", opciones: ["Dos eixos molt junts que reparteixen pes", "Un sol eix", "Un tipus de fre"], correcta: 0, explicacion: "Millora repartiment de càrrega i tracció.", tip: "Tàndem = dos eixos junts per repartir pes." },
  { id: "M-09-05", panel_id: "M-09", ruta_panel: "M-09_CAMION_INDUSTRIAL.jpg", categoria: "MECANICA", pictograma: "FRENO_AIRE", pregunta: "Com frena un camió d'aire comprimit?", opciones: ["Usa aire a pressió, si falta aire es bloqueja per seguretat", "Només amb líquid com cotxe", "No frena"], correcta: 0, explicacion: "Fre pneumàtic: sense aire, molles bloquegen rodes = seguretat.", tip: "Sense aire, es bloqueja per seguretat." },
  { id: "M-09-06", panel_id: "M-09", ruta_panel: "M-09_CAMION_INDUSTRIAL.jpg", categoria: "MECANICA", pictograma: "RETARDER", pregunta: "Per a què serveix el retarder?", opciones: ["Fre auxiliar que evita sobreescalfar frens en baixades", "Accelerar", "Filtrar gasoil"], correcta: 0, explicacion: "Ralentitzador electromagnètic o hidràulic, estalvia frens.", tip: "Retarder = fre auxiliar per a baixades." },

  // ===== M-10_HERRAMIENTAS_V16.jpg =====
  { id: "M-10-01", panel_id: "M-10", ruta_panel: "M-10_HERRAMIENTAS_V16.jpg", categoria: "MECANICA", pictograma: "GATO", pregunta: "On es col·loca el gat per canviar roda?", opciones: ["En punts reforçats del xassís indicats al manual", "En qualsevol xapa", "Al para-xocs de plàstic"], correcta: 0, explicacion: "Punts específics per no deformar carrosseria.", tip: "Gat sempre en punt reforçat del manual." },
  { id: "M-10-02", panel_id: "M-10", ruta_panel: "M-10_HERRAMIENTAS_V16.jpg", categoria: "MECANICA", pictograma: "LLAVE_RUEDAS", pregunta: "Com afluixar cargols de roda?", opciones: ["En creu, abans d'aixecar cotxe", "Després d'aixecar", "És igual"], correcta: 0, explicacion: "Afluixar a terra en creu, després aixecar i treure.", tip: "En creu i a terra, després aixeca." },
  { id: "M-10-03", panel_id: "M-10", ruta_panel: "M-10_HERRAMIENTAS_V16.jpg", categoria: "MECANICA", pictograma: "V16", pregunta: "Què és la balisa V16?", opciones: ["Llum groga intermitent que substitueix triangles des de 2026", "Un extintor", "Un gat"], correcta: 0, explicacion: "Es col·loca al sostre, visible 360º, amb connectivitat DGT 3.0.", tip: "V16 al sostre, 360º, obligatòria des de 2026." },
  { id: "M-10-04", panel_id: "M-10", ruta_panel: "M-10_HERRAMIENTAS_V16.jpg", categoria: "MECANICA", pictograma: "CHALECO", pregunta: "Quan posar-se l'armilla reflectant?", opciones: ["Abans de sortir del vehicle en via interurbana", "Dins del cotxe", "Només de nit"], correcta: 0, explicacion: "Obligatori sortir amb armilla posada a la calçada.", tip: "Posa't l'armilla abans de sortir." },
  { id: "M-10-05", panel_id: "M-10", ruta_panel: "M-10_HERRAMIENTAS_V16.jpg", categoria: "MECANICA", pictograma: "TRIANGULO", pregunta: "Segueixen obligatoris els triangles amb V16?", opciones: ["No, des de 2026 només V16 obligatòria", "Sí, dos triangles sempre", "Només un"], correcta: 0, explicacion: "Norma actual: V16 substitueix triangles.", tip: "Des de 2026, només V16." },
  { id: "M-10-06", panel_id: "M-10", ruta_panel: "M-10_HERRAMIENTAS_V16.jpg", categoria: "MECANICA", pictograma: "EXTINTOR", pregunta: "Quin extintor ha de portar camió?", opciones: ["Extintor pols ABC revisat i accessible", "No necessita", "D'aigua només"], correcta: 0, explicacion: "Obligatori en pesants, revisat i amb pressió correcta.", tip: "Pols ABC revisat i accessible." },

  // ===== M-11_RESTO_TEMARIO.jpg =====
  { id: "M-11-01", panel_id: "M-11", ruta_panel: "M-11_RESTO_TEMARIO.jpg", categoria: "MECANICA", pictograma: "BASTIDOR", pregunta: "Què és el bastidor independent?", opciones: ["Xassís separat de carrosseria típic en camions i tot terrenys", "Carrosseria autoportant", "Un filtre"], correcta: 0, explicacion: "Més robust, permet torsió en camp.", tip: "Bastidor independent = més robust, camions i 4x4." },
  { id: "M-11-02", panel_id: "M-11", ruta_panel: "M-11_RESTO_TEMARIO.jpg", categoria: "MECANICA", pictograma: "CARROCERIA_DEFORMACION", pregunta: "Què és deformació programada?", opciones: ["Carrosseria dissenyada per absorbir impacte deformant-se", "Carrosseria que no es deforma", "Un tipus de pintura"], correcta: 0, explicacion: "Zona davantera/darrere es deforma per protegir habitacle.", tip: "Es deforma per protegir-te a tu." },
  { id: "M-11-03", panel_id: "M-11", ruta_panel: "M-11_RESTO_TEMARIO.jpg", categoria: "MECANICA", pictograma: "AIRBAG", pregunta: "L'airbag substitueix el cinturó?", opciones: ["No, és complement del cinturó", "Sí, ja no cal cinturó", "Només a ciutat"], correcta: 0, explicacion: "Airbag sense cinturó pot ser letal. Sempre amb cinturó.", tip: "Airbag sense cinturó = perillós. Sempre cordat." },
  { id: "M-11-04", panel_id: "M-11", ruta_panel: "M-11_RESTO_TEMARIO.jpg", categoria: "MECANICA", pictograma: "CATALIZADOR", pregunta: "Què fa el catalitzador?", opciones: ["Redueix gasos contaminants transformant-los", "Augmenta potència", "Filtra oli"], correcta: 0, explicacion: "Converteix CO, HC i NOx en gasos menys nocius.", tip: "Catalitzador = menys contaminació." },
  { id: "M-11-05", panel_id: "M-11", ruta_panel: "M-11_RESTO_TEMARIO.jpg", categoria: "MECANICA", pictograma: "SONDA_LAMBDA", pregunta: "Què mesura la sonda lambda?", opciones: ["Oxigen a l'escapament per ajustar mescla", "Temperatura de l'oli", "Pressió de rodes"], correcta: 0, explicacion: "Informa a centraleta si mescla és rica o pobra.", tip: "Mesura oxigen a l'escapament." },
  { id: "M-11-06", panel_id: "M-11", ruta_panel: "M-11_RESTO_TEMARIO.jpg", categoria: "MECANICA", pictograma: "INYECCION_ECO", pregunta: "Què és conducció econòmica relacionada amb injecció?", opciones: ["Conduir suau, marxes llargues, anticipació per gastar menys", "Accelerar molt", "Frenar fort"], correcta: 0, explicacion: "Injecció electrònica + conducció eficient = menys consum i contaminació.", tip: "Suau, marxes llargues, anticipació = menys consum." }
],
