...
const PREGUNTES = {
  ...
  senyals: [
  // ===== 180 SENYALS DGT RD 465/2025 =====
  {id:1000,codigo:"r-1",q:"¿Qué significa la señal R-1?",a:["Stop","Ceda el paso","Prohibido entrar"],ok:0,subtema:"Senyals STOP",pag:45,img:`<div style="background:#c00;color:white;font-size:50px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-1</div>`},
  {id:1001,codigo:"r-2",q:"¿Qué significa la señal R-2?",a:["Ceda el paso","Parada obligatoria total","Ceda en intersección"],ok:0,subtema:"Senyals STOP",pag:45,img:`<div style="background:white;color:#c00;border:4px solid #c00;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-2</div>`},
  {id:1002,codigo:"r-3",q:"¿Qué indica la señal R-3?",a:["Fin de prioridad","Calzada con prioridad","Intersección con prioridad"],ok:1,subtema:"Senyals Prioritat",pag:45,img:`<div style="background:white;color:#000;border:3px solid #000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-3</div>`},
  {id:1003,codigo:"r-4",q:"¿Qué indica la señal R-4?",a:["Inicio de prioridad","Fin de calzada con prioridad","Ceda el paso"],ok:1,subtema:"Senyals Prioritat",pag:45,img:`<div style="background:white;color:#000;border:3px solid #000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-4</div>`},
  {id:1004,codigo:"r-5",q:"¿Qué significa la señal R-5?",a:["Usted tiene prioridad","Prioridad para sentido contrario","Stop obligatorio"],ok:0,subtema:"Senyals Prioritat",pag:45,img:`<div style="background:white;color:#000;border:3px solid #000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-5</div>`},
  {id:1005,codigo:"r-6",q:"¿Qué significa la señal R-6?",a:["Ceda el paso","Tiene prioridad respecto al sentido contrario","Prohibido pasar"],ok:1,subtema:"Senyals Prioritat",pag:45,img:`<div style="background:white;color:#000;border:3px solid #000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-6</div>`},
  {id:1006,codigo:"r-101",q:"¿Qué significa la señal R-101?",a:["Obligación de girar","Prohibición de entrada a toda clase de vehículos","Fin de prohibiciones"],ok:1,subtema:"Senyals Prohibició",pag:46,img:`<div style="background:#c00;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-101</div>`},
  {id:1007,codigo:"r-102",q:"¿Qué significa la señal R-102?",a:["Prohibida entrada a bicicletas","Prohibida entrada a vehículos de motor","Prohibida entrada a peatones"],ok:1,subtema:"Senyals Prohibició",pag:46,img:`<div style="background:#c00;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-102</div>`},
  {id:1008,codigo:"r-103",q:"¿Qué significa la señal R-103?",a:["Prohibida entrada a turismos","Prohibida entrada a camiones","Prohibida entrada a autobuses"],ok:0,subtema:"Senyals Prohibició",pag:46,img:`<div style="background:#c00;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-103</div>`},
  {id:1009,codigo:"r-104",q:"¿Qué significa la señal R-104?",a:["Prohibida entrada a ciclomotores","Prohibida entrada a motocicletas","Prohibida entrada a turismos"],ok:1,subtema:"Senyals Prohibició",pag:46,img:`<div style="background:#c00;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-104</div>`},
  {id:1010,codigo:"r-105",q:"¿Qué significa la señal R-105?",a:["Prohibida entrada a turismos","Prohibida entrada a camiones","Prohibida entrada a autobuses"],ok:1,subtema:"Senyals Prohibició",pag:46,img:`<div style="background:#c00;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-105</div>`},
  {id:1011,codigo:"r-106",q:"¿Qué significa la señal R-106?",a:["Prohibida entrada a camiones","Prohibida entrada a autobuses","Prohibida entrada a taxis"],ok:0,subtema:"Senyals Prohibició",pag:46,img:`<div style="background:#c00;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-106</div>`},
  {id:1012,codigo:"r-107",q:"¿Qué significa la señal R-107?",a:["Prohibida entrada a motocicletas","Prohibida entrada a bicicletas","Prohibida entrada a peatones"],ok:2,subtema:"Senyals Prohibició",pag:46,img:`<div style="background:#c00;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-107</div>`},
  {id:1013,codigo:"r-108",q:"¿Qué significa la señal R-108?",a:["Prohibida entrada a bicicletas","Prohibida entrada a ciclomotores","Prohibida entrada a motocicletas"],ok:0,subtema:"Senyals Prohibició",pag:46,img:`<div style="background:#c00;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-108</div>`},
  {id:1014,codigo:"r-109",q:"¿Qué significa la señal R-109?",a:["Prohibida entrada a vehículos agrícolas","Prohibida entrada a turismos","Prohibida entrada a autobuses"],ok:0,subtema:"Senyals Prohibició",pag:46,img:`<div style="background:#c00;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-109</div>`},
  {id:1015,codigo:"r-110",q:"¿Qué significa la señal R-110?",a:["Prohibida entrada a carros de mano","Prohibida entrada a peatones","Prohibida entrada a bicicletas"],ok:0,subtema:"Senyals Prohibició",pag:46,img:`<div style="background:#c00;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-110</div>`},
  {id:1016,codigo:"r-111",q:"¿Qué significa la señal R-111?",a:["Prohibida entrada a camiones","Prohibida entrada a vehículos agrícolas","Prohibida entrada a autobuses"],ok:1,subtema:"Senyals Prohibició",pag:46,img:`<div style="background:#c00;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-111</div>`},
  {id:1017,codigo:"r-112",q:"¿Qué significa la señal R-112?",a:["Prohibida entrada a peatones","Prohibida entrada a animales de montura","Prohibida entrada a bicicletas"],ok:1,subtema:"Senyals Prohibició",pag:46,img:`<div style="background:#c00;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-112</div>`},
  {id:1018,codigo:"r-113",q:"¿Qué significa la señal R-113?",a:["Prohibida entrada a peatones","Prohibida entrada a carros de mano","Prohibida entrada a bicicletas"],ok:0,subtema:"Senyals Prohibició",pag:46,img:`<div style="background:#c00;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-113</div>`},
  {id:1019,codigo:"r-114",q:"¿Qué significa la señal R-114?",a:["Prohibida entrada a bicicletas","Prohibida entrada a peatones","Prohibida entrada a motos"],ok:0,subtema:"Senyals Prohibició",pag:46,img:`<div style="background:#c00;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-114</div>`},
  {id:1020,codigo:"r-115",q:"¿Qué significa la señal R-115?",a:["Prohibida entrada a animales sueltos","Prohibida entrada a peatones","Prohibida entrada a bicicletas"],ok:0,subtema:"Senyals Prohibició",pag:46,img:`<div style="background:#c00;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-115</div>`},
  {id:1021,codigo:"r-116",q:"¿Qué significa la señal R-116?",a:["Prohibida entrada a peatones","Prohibida entrada a animales sueltos","Prohibida entrada a bicicletas"],ok:1,subtema:"Senyals Prohibició",pag:46,img:`<div style="background:#c00;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-116</div>`},
  {id:1022,codigo:"r-300",q:"¿Qué significa la señal R-300?",a:["Velocidad mínima 50 km/h","Velocidad máxima 50 km/h","Velocidad recomendada 50 km/h"],ok:1,subtema:"Senyals Velocitat",pag:47,img:`<div style="background:white;color:#000;border:4px solid #000;border-radius:50%;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%">R-300</div>`},
  {id:1023,codigo:"r-301",q:"¿Qué significa la señal R-301?",a:["Inicio limitación 50","Fin de limitación de velocidad máxima","Nueva limitación 50"],ok:1,subtema:"Senyals Velocitat",pag:47,img:`<div style="background:white;color:#000;border:4px solid #000;border-radius:50%;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%">R-301</div>`},
  {id:1024,codigo:"r-302",q:"¿Qué significa la señal R-302?",a:["Giro izquierda permitido","Prohibido girar a la izquierda","Obligatorio girar izquierda"],ok:1,subtema:"Senyals Prohibició",pag:46,img:`<div style="background:#c00;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-302</div>`},
  {id:1025,codigo:"r-303",q:"¿Qué significa la señal R-303?",a:["Giro derecha permitido","Prohibido girar a la derecha","Obligatorio girar derecha"],ok:1,subtema:"Senyals Prohibició",pag:46,img:`<div style="background:#c00;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-303</div>`},
  {id:1026,codigo:"r-304",q:"¿Qué significa la señal R-304?",a:["Cambio sentido permitido","Prohibido efectuar cambio de sentido","Obligatorio cambio sentido"],ok:1,subtema:"Senyals Prohibició",pag:46,img:`<div style="background:#c00;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-304</div>`},
  {id:1027,codigo:"r-305",q:"¿Qué significa la señal R-305?",a:["Adelantamiento permitido","Prohibido adelantar","Obligatorio adelantar"],ok:1,subtema:"Senyals Prohibició",pag:46,img:`<div style="background:#c00;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-305</div>`},
  {id:1028,codigo:"r-306",q:"¿Qué significa la señal R-306?",a:["Inicio prohibición","Fin de prohibición de adelantar","Adelantamiento obligatorio"],ok:1,subtema:"Senyals Prohibició",pag:46,img:`<div style="background:#c00;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-306</div>`},
  {id:1029,codigo:"r-307",q:"¿Qué significa la señal R-307?",a:["Prohibido turismos adelantar","Prohibido adelantar a camiones","Prohibido autobuses adelantar"],ok:1,subtema:"Senyals Prohibició",pag:46,img:`<div style="background:#c00;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-307</div>`},
  {id:1030,codigo:"r-308",q:"¿Qué significa la señal R-308?",a:["Inicio prohibición camiones","Fin de prohibición de adelantar a camiones","Turismos pueden adelantar"],ok:1,subtema:"Senyals Prohibició",pag:46,img:`<div style="background:#c00;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-308</div>`},
  {id:1031,codigo:"r-309",q:"¿Qué significa la señal R-309?",a:["Zona adelantar permitido","Zona con prohibición de adelantar","Fin prohibición adelantar"],ok:1,subtema:"Senyals Prohibició",pag:46,img:`<div style="background:#c00;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-309</div>`},
  {id:1032,codigo:"r-310",q:"¿Qué significa la señal R-310?",a:["Uso obligatorio claxon","Prohibido uso de señales acústicas","Fin prohibición claxon"],ok:1,subtema:"Senyals Prohibició",pag:46,img:`<div style="background:#c00;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-310</div>`},
  {id:1033,codigo:"r-311",q:"¿Qué significa la señal R-311?",a:["Velocidad mínima 30 km/h","Velocidad máxima 30 km/h","Fin velocidad mínima"],ok:0,subtema:"Senyals Velocitat",pag:47,img:`<div style="background:white;color:#000;border:4px solid #000;border-radius:50%;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%">R-311</div>`},
  {id:1034,codigo:"r-400",q:"¿Qué significa la señal R-400?",a:["Prohibición","Sentido obligatorio","Fin de obligación"],ok:1,subtema:"Senyals Obligació",pag:48,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-400</div>`},
  {id:1035,codigo:"r-401",q:"¿Qué significa la señal R-401?",a:["Prohibido girar derecha","Sentido obligatorio a la derecha","Giro derecha recomendado"],ok:1,subtema:"Senyals Obligació",pag:48,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-401</div>`},
  {id:1036,codigo:"r-402",q:"¿Qué significa la señal R-402?",a:["Prohibido girar izquierda","Sentido obligatorio a la izquierda","Giro izquierda recomendado"],ok:1,subtema:"Senyals Obligació",pag:48,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-402</div>`},
  {id:1037,codigo:"r-403",q:"¿Qué significa la señal R-403?",a:["Prohibido pasar derecha","Paso obligatorio por la derecha del obstáculo","Fin obligación"],ok:1,subtema:"Senyals Obligació",pag:48,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-403</div>`},
  {id:1038,codigo:"r-404",q:"¿Qué significa la señal R-404?",a:["Prohibido pasar izquierda","Paso obligatorio por la izquierda del obstáculo","Fin obligación"],ok:1,subtema:"Senyals Obligació",pag:48,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-404</div>`},
  {id:1039,codigo:"r-405",q:"¿Qué significa la señal R-405?",a:["Giro obligatorio","Sentido obligatorio de frente","Prohibido recto"],ok:1,subtema:"Senyals Obligació",pag:48,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-405</div>`},
  {id:1040,codigo:"r-406",q:"¿Qué significa la señal R-406?",a:["Prohibido recto","Sentido obligatorio a la derecha o izquierda","Obligatorio girar"],ok:1,subtema:"Senyals Obligació",pag:48,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-406</div>`},
  {id:1041,codigo:"r-407",q:"¿Qué significa la señal R-407?",a:["Prohibido encender luces","Vía obligatoria para ciclistas","Vía recomendada ciclistas"],ok:1,subtema:"Senyals Obligació",pag:48,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-407</div>`},
  {id:1042,codigo:"r-408",q:"¿Qué significa la señal R-408?",a:["Prohibido peatones","Vía obligatoria para peatones","Solo bicicletas"],ok:1,subtema:"Senyals Obligació",pag:48,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-408</div>`},
  {id:1043,codigo:"r-409",q:"¿Qué significa la señal R-409?",a:["Prohibido peatones","Vía obligatoria para peatones y ciclos","Solo peatones"],ok:1,subtema:"Senyals Obligació",pag:48,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-409</div>`},
  {id:1044,codigo:"r-410",q:"¿Qué significa la señal R-410?",a:["Prohibido peatones","Vía obligatoria para peatones y ciclos","Solo peatones"],ok:1,subtema:"Senyals Obligació",pag:48,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-410</div>`},
  {id:1045,codigo:"r-411",q:"¿Qué significa la señal R-411?",a:["Velocidad máxima 30","Velocidad mínima 30 km/h","Fin velocidad mínima"],ok:1,subtema:"Senyals Velocitat",pag:47,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-411</div>`},
  {id:1046,codigo:"r-412",q:"¿Qué significa la señal R-412?",a:["Inicio velocidad mínima","Fin de velocidad mínima","Nueva velocidad mínima"],ok:0,subtema:"Senyals Velocitat",pag:47,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-412</div>`},
  {id:1047,codigo:"r-413",q:"¿Qué significa la señal R-413?",a:["Prohibido encender luces","Uso obligatorio alumbrado de cruce","Recomendado luces"],ok:1,subtema:"Senyals Obligació",pag:48,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-413</div>`},
  {id:1048,codigo:"r-414",q:"¿Qué significa la señal R-414?",a:["Inicio obligación luces","Fin uso obligatorio alumbrado de cruce","Luces prohibidas"],ok:1,subtema:"Senyals Obligació",pag:48,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-414</div>`},
  {id:1049,codigo:"r-415",q:"¿Qué significa la señal R-415?",a:["Prohibido cadenas","Cadenas para nieve obligatorias","Cadenas recomendadas"],ok:1,subtema:"Senyals Obligació",pag:48,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-415</div>`},
  {id:1050,codigo:"r-416",q:"¿Qué significa la señal R-416?",a:["Inicio cadenas","Fin cadenas para nieve obligatorias","Cadenas recomendadas"],ok:1,subtema:"Senyals Obligació",pag:48,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-416</div>`},
  {id:1051,codigo:"r-417",q:"¿Qué significa la señal R-417?",a:["Prohibido cinturón","Uso obligatorio cinturón de seguridad","Cinturón recomendado"],ok:1,subtema:"Senyals Obligació",pag:48,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-417</div>`},
  {id:1052,codigo:"r-418",q:"¿Qué significa la señal R-418?",a:["Prohibido coches","Vía reservada para automóviles","Vía recomendada coches"],ok:1,subtema:"Senyals Obligació",pag:48,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-418</div>`},
  {id:1053,codigo:"r-419",q:"¿Qué significa la señal R-419?",a:["Prohibido camiones","Vía reservada para camiones","Vía recomendada camiones"],ok:1,subtema:"Senyals Obligació",pag:48,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-419</div>`},
  {id:1054,codigo:"r-420",q:"¿Qué significa la señal R-420?",a:["Prohibido autobuses","Vía reservada para autobuses","Vía recomendada autobuses"],ok:1,subtema:"Senyals Obligació",pag:48,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-420</div>`},
  {id:1055,codigo:"r-421",q:"¿Qué significa la señal R-421?",a:["Prohibido taxis","Vía reservada para taxis","Vía recomendada taxis"],ok:1,subtema:"Senyals Obligació",pag:48,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-421</div>`},
  {id:1056,codigo:"r-422",q:"¿Qué significa la señal R-422?",a:["Inicio vía reservada","Fin vía reservada para automóviles","Vía compartida"],ok:0,subtema:"Senyals Obligació",pag:48,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">R-422</div>`},
  {id:1057,codigo:"p-1",q:"¿Qué indica la señal P-1?",a:["Peligro específico","Peligro indefinido","Fin peligro"],ok:1,subtema:"Senyals Perill",pag:40,img:`<div style="background:#ffcc00;color:#000;font-size:50px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;clip-path:polygon(50% 0%, 100% 100%, 0% 100%)">P-1</div>`},
  {id:1058,codigo:"p-2",q:"¿Qué indica la señal P-2?",a:["Intersección sin prioridad","Intersección con prioridad a la derecha","Ceda el paso"],ok:0,subtema:"Senyals Perill",pag:40,img:`<div style="background:#ffcc00;color:#000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;clip-path:polygon(50% 0%, 100% 100%, 0% 100%)">P-2</div>`},
  {id:1059,codigo:"p-3",q:"¿Qué indica la señal P-3?",a:["Semáforo apagado","Peligro por proximidad de semáforos","Prohibido semáforos"],ok:1,subtema:"Senyals Perill",pag:40,img:`<div style="background:#ffcc00;color:#000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;clip-path:polygon(50% 0%, 100% 100%, 0% 100%)">P-3</div>`},
  {id:1060,codigo:"p-4",q:"¿Qué indica la señal P-4?",a:["Prohibido girar","Intersección de sentido giratorio obligatorio","Ceda en rotonda"],ok:1,subtema:"Senyals Perill",pag:40,img:`<div style="background:#ffcc00;color:#000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;clip-path:polygon(50% 0%, 100% 100%, 0% 100%)">P-4</div>`},
  {id:1061,codigo:"p-13a",q:"¿Qué indica la señal P-13a?",a:["Curva suave derecha","Curva peligrosa a la derecha","Giro obligatorio derecha"],ok:1,subtema:"Senyals Perill",pag:40,img:`<div style="background:#ffcc00;color:#000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;clip-path:polygon(50% 0%, 100% 100%, 0% 100%)">P-13a</div>`},
  {id:1062,codigo:"p-13b",q:"¿Qué indica la señal P-13b?",a:["Curva suave izquierda","Curva peligrosa a la izquierda","Giro obligatorio izquierda"],ok:1,subtema:"Senyals Perill",pag:40,img:`<div style="background:#ffcc00;color:#000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;clip-path:polygon(50% 0%, 100% 100%, 0% 100%)">P-13b</div>`},
  {id:1063,codigo:"p-14a",q:"¿Qué indica la señal P-14a?",a:["Curva única","Sucesión de curvas peligrosas, primera a derecha","Prohibido curvar"],ok:1,subtema:"Senyals Perill",pag:40,img:`<div style="background:#ffcc00;color:#000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;clip-path:polygon(50% 0%, 100% 100%, 0% 100%)">P-14a</div>`},
  {id:1064,codigo:"p-14b",q:"¿Qué indica la señal P-14b?",a:["Curva única","Sucesión de curvas peligrosas, primera a izquierda","Prohibido curvar"],ok:1,subtema:"Senyals Perill",pag:40,img:`<div style="background:#ffcc00;color:#000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;clip-path:polygon(50% 0%, 100% 100%, 0% 100%)">P-14b</div>`},
  {id:1065,codigo:"p-15",q:"¿Qué indica la señal P-15?",a:["Calzada lisa","Perfil irregular de la calzada, badenes","Zona obras"],ok:1,subtema:"Senyals Perill",pag:40,img:`<div style="background:#ffcc00;color:#000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;clip-path:polygon(50% 0%, 100% 100%, 0% 100%)">P-15</div>`},
  {id:1066,codigo:"p-16a",q:"¿Qué indica la señal P-16a?",a:["Ascenso pendiente","Descenso con fuerte pendiente","Curva peligrosa"],ok:1,subtema:"Senyals Perill",pag:40,img:`<div style="background:#ffcc00;color:#000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;clip-path:polygon(50% 0%, 100% 100%, 0% 100%)">P-16a</div>`},
  {id:1067,codigo:"p-16b",q:"¿Qué indica la señal P-16b?",a:["Descenso pendiente","Ascenso con fuerte pendiente","Curva peligrosa"],ok:0,subtema:"Senyals Perill",pag:40,img:`<div style="background:#ffcc00;color:#000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;clip-path:polygon(50% 0%, 100% 100%, 0% 100%)">P-16b</div>`},
  {id:1068,codigo:"p-17",q:"¿Qué indica la señal P-17?",a:["Ensanchamiento calzada","Estrechamiento de calzada","Puente estrecho"],ok:1,subtema:"Senyals Perill",pag:40,img:`<div style="background:#ffcc00;color:#000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;clip-path:polygon(50% 0%, 100% 100%, 0% 100%)">P-17</div>`},
{id:1069,codigo:"p-20",q:"¿Qué indica la señal P-20?",a:["Prohibido peatones","Peligro por proximidad de paso de peatones","Zona peatonal"],ok:1,subtema:"Senyals Perill",pag:40,img:`<div style="background:#ffcc00;color:#000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;clip-path:polygon(50% 0%, 100% 100%, 0% 100%)">P-20</div>`},
{id:1070,codigo:"p-21",q:"¿Qué indica la señal P-21?",a:["Zona escolar, peligro por proximidad de niños","Parque infantil","Prohibido niños"],ok:0,subtema:"Senyals Perill",pag:40,img:`<div style="background:#ffcc00;color:#000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;clip-path:polygon(50% 0%, 100% 100%, 0% 100%)">P-21</div>`},
{id:1071,codigo:"p-22",q:"¿Qué indica la señal P-22?",a:["Prohibido bicis","Peligro por proximidad de ciclistas","Carril bici"],ok:1,subtema:"Senyals Perill",pag:40,img:`<div style="background:#ffcc00;color:#000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;clip-path:polygon(50% 0%, 100% 100%, 0% 100%)">P-22</div>`},
{id:1072,codigo:"p-23",q:"¿Qué indica la señal P-23?",a:["Prohibido animales","Peligro por proximidad de animales domésticos","Granja"],ok:1,subtema:"Senyals Perill",pag:40,img:`<div style="background:#ffcc00;color:#000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;clip-path:polygon(50% 0%, 100% 100%, 0% 100%)">P-23</div>`},
{id:1073,codigo:"p-24",q:"¿Qué indica la señal P-24?",a:["Prohibido cazar","Peligro por proximidad de animales salvajes","Zona zoo"],ok:1,subtema:"Senyals Perill",pag:40,img:`<div style="background:#ffcc00;color:#000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;clip-path:polygon(50% 0%, 100% 100%, 0% 100%)">P-24</div>`},
{id:1074,codigo:"p-25",q:"¿Qué indica la señal P-25?",a:["Sentido único","Circulación en ambos sentidos","Prohibido adelantar"],ok:1,subtema:"Senyals Perill",pag:40,img:`<div style="background:#ffcc00;color:#000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;clip-path:polygon(50% 0%, 100% 100%, 0% 100%)">P-25</div>`},
{id:1075,codigo:"p-26",q:"¿Qué indica la señal P-26?",a:["Zona segura","Zona con desprendimientos","Prohibido parar"],ok:1,subtema:"Senyals Perill",pag:40,img:`<div style="background:#ffcc00;color:#000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;clip-path:polygon(50% 0%, 100% 100%, 0% 100%)">P-26</div>`},
{id:1076,codigo:"p-27",q:"¿Qué indica la señal P-27?",a:["Calzada asfaltada","Peligro por proyección de gravilla","Zona obras"],ok:1,subtema:"Senyals Perill",pag:40,img:`<div style="background:#ffcc00;color:#000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;clip-path:polygon(50% 0%, 100% 100%, 0% 100%)">P-27</div>`},
{id:1077,codigo:"p-28",q:"¿Qué indica la señal P-28?",a:["Calzada asfaltada","Peligro por proyección de gravilla","Zona obras"],ok:1,subtema:"Senyals Perill",pag:40,img:`<div style="background:#ffcc00;color:#000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;clip-path:polygon(50% 0%, 100% 100%, 0% 100%)">P-28</div>`},
{id:1078,codigo:"p-29",q:"¿Qué indica la señal P-29?",a:["Viento frontal","Peligro por viento lateral fuerte","Prohibido circular"],ok:1,subtema:"Senyals Perill",pag:40,img:`<div style="background:#ffcc00;color:#000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;clip-path:polygon(50% 0%, 100% 100%, 0% 100%)">P-29</div>`},
{id:1079,codigo:"p-30",q:"¿Qué indica la señal P-30?",a:["Baden","Peligro por escalón lateral en la calzada","Zona obras"],ok:1,subtema:"Senyals Perill",pag:40,img:`<div style="background:#ffcc00;color:#000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;clip-path:polygon(50% 0%, 100% 100%, 0% 100%)">P-30</div>`},
{id:1080,codigo:"p-31",q:"¿Qué indica la señal P-31?",a:["Vía libre","Peligro por congestión de tráfico","Fin congestión"],ok:1,subtema:"Senyals Perill",pag:40,img:`<div style="background:#ffcc00;color:#000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;clip-path:polygon(50% 0%, 100% 100%, 0% 100%)">P-31</div>`},
{id:1081,codigo:"p-32",q:"¿Qué indica la señal P-32?",a:["Calzada libre","Peligro por obstrucción en la calzada","Prohibido parar"],ok:1,subtema:"Senyals Perill",pag:40,img:`<div style="background:#ffcc00;color:#000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;clip-path:polygon(50% 0%, 100% 100%, 0% 100%)">P-32</div>`},
{id:1082,codigo:"p-33",q:"¿Qué indica la señal P-33?",a:["Día claro","Peligro por visibilidad reducida, niebla","Túnel"],ok:1,subtema:"Senyals Perill",pag:40,img:`<div style="background:#ffcc00;color:#000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;clip-path:polygon(50% 0%, 100% 100%, 0% 100%)">P-33</div>`},
{id:1083,codigo:"p-34",q:"¿Qué indica la señal P-34?",a:["Pavimento mojado","Pavimento deslizante por hielo o nieve","Zona obras"],ok:1,subtema:"Senyals Perill",pag:40,img:`<div style="background:#ffcc00;color:#000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;clip-path:polygon(50% 0%, 100% 100%, 0% 100%)">P-34</div>`},
{id:1084,codigo:"p-50",q:"¿Qué indica la señal P-50?",a:["Peligro concreto","Peligro por otros motivos","Fin peligros"],ok:1,subtema:"Senyals Perill",pag:40,img:`<div style="background:#ffcc00;color:#000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;clip-path:polygon(50% 0%, 100% 100%, 0% 100%)">P-50</div>`},
{id:1085,codigo:"s-50",q:"¿Qué indica la señal S-50?",a:["Carril bus","Carriles reservados sentido contrario al habitual","Carril bici"],ok:1,subtema:"Senyals Indicació",pag:50,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-50</div>`},
{id:1086,codigo:"s-51",q:"¿Qué indica la señal S-51?",a:["Carril libre","Carril reservado para autobuses y taxis","Prohibido bus"],ok:1,subtema:"Senyals Indicació",pag:50,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-51</div>`},
{id:1087,codigo:"s-52",q:"¿Qué indica la señal S-52?",a:["Inicio carril bus","Fin de carril reservado para autobuses","Carril compartido"],ok:1,subtema:"Senyals Indicació",pag:50,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-52</div>`},
{id:1088,codigo:"s-53",q:"¿Qué indica la señal S-53?",a:["Carril bus solo","Carril reservado para bus y VAO","Carril bici"],ok:1,subtema:"Senyals Indicació",pag:50,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-53</div>`},
{id:1089,codigo:"s-54",q:"¿Qué indica la señal S-54?",a:["Carril libre","Carril reservado para bicicletas","Prohibido bicis"],ok:1,subtema:"Senyals Indicació",pag:50,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-54</div>`},
{id:1090,codigo:"s-55",q:"¿Qué indica la señal S-55?",a:["Carril libre","Carril reservado para peatones","Prohibido peatones"],ok:1,subtema:"Senyals Indicació",pag:50,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-55</div>`},
{id:1091,codigo:"s-56",q:"¿Qué indica la señal S-56?",a:["Carril libre","Carril reservado para peatones y ciclos","Prohibido peatones"],ok:1,subtema:"Senyals Indicació",pag:50,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-56</div>`},
{id:1092,codigo:"s-57",q:"¿Qué indica la señal S-57?",a:["Carril libre","Carril reservado para peatones y ciclos","Solo peatones"],ok:1,subtema:"Senyals Indicació",pag:50,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-57</div>`},
{id:1093,codigo:"s-58",q:"¿Qué indica la señal S-58?",a:["Carril libre","Carril reservado para peatones y ciclos","Solo ciclos"],ok:1,subtema:"Senyals Indicació",pag:50,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-58</div>`},
{id:1094,codigo:"s-114",q:"¿Qué indica la señal S-114?",a:["Prohibido estacionar","Aparcamiento","Parada bus"],ok:1,subtema:"Senyals Indicació",pag:50,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-114</div>`},
{id:1095,codigo:"s-115",q:"¿Qué indica la señal S-115?",a:["Aparcamiento","Aparcamiento cubierto","Prohibido aparcar"],ok:0,subtema:"Senyals Indicació",pag:50,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-115</div>`},
{id:1096,codigo:"s-116",q:"¿Qué indica la señal S-116?",a:["Aparcamiento","Aparcamiento vigilado","Prohibido aparcar"],ok:0,subtema:"Senyals Indicació",pag:50,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-116</div>`},
{id:1097,codigo:"s-117",q:"¿Qué indica la señal S-117?",a:["Hotel","Hospital","Helipuerto"],ok:1,subtema:"Senyals Serveis",pag:51,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-117</div>`},
{id:1098,codigo:"s-118",q:"¿Qué indica la señal S-118?",a:["Hospital","Puesto de socorro","Farmacia"],ok:1,subtema:"Senyals Serveis",pag:51,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-118</div>`},
{id:1099,codigo:"s-119",q:"¿Qué indica la señal S-119?",a:["Taller","Báscula para camiones","Gasolinera"],ok:0,subtema:"Senyals Serveis",pag:51,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-119</div>`},
{id:1100,codigo:"s-120",q:"¿Qué indica la señal S-120?",a:["Hotel","Control de policía","Aduana"],ok:1,subtema:"Senyals Serveis",pag:51,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-120</div>`},
{id:1101,codigo:"s-121",q:"¿Qué indica la señal S-121?",a:["Gasolinera","Extintor de incendios","Taller"],ok:1,subtema:"Senyals Serveis",pag:51,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-121</div>`},
{id:1102,codigo:"s-122",q:"¿Qué indica la señal S-122?",a:["Información","Salida de emergencia","Prohibición"],ok:0,subtema:"Senyals Serveis",pag:51,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-122</div>`},
{id:1103,codigo:"s-123",q:"¿Qué indica la señal S-123?",a:["Gasolinera","Área de servicio completa","Hotel"],ok:1,subtema:"Senyals Serveis",pag:51,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-123</div>`},
{id:1104,codigo:"s-124",q:"¿Qué indica la señal S-124?",a:["Gasolinera","Punto de recarga vehículo eléctrico","Taller"],ok:1,subtema:"Senyals Serveis",pag:51,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-124</div>`},
{id:1105,codigo:"s-125",q:"¿Qué indica la señal S-125?",a:["Hotel","Punto de información turística","Policía"],ok:1,subtema:"Senyals Serveis",pag:51,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-125</div>`},
{id:1106,codigo:"s-126",q:"¿Qué indica la señal S-126?",a:["Taller","Centro inspección técnica vehículos","Gasolinera"],ok:1,subtema:"Senyals Serveis",pag:51,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-126</div>`},
{id:1107,codigo:"s-230",q:"¿Qué indica la señal S-230?",a:["Carriles con direcciones obligatorias","Carriles libres","Prohibido cambiar carril"],ok:0,subtema:"Senyals Carrils",pag:52,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-230</div>`},
{id:1108,codigo:"s-231",q:"¿Qué indica la señal S-231?",a:["Carriles con direcciones obligatorias","Carriles libres","Prohibido cambiar carril"],ok:0,subtema:"Senyals Carrils",pag:52,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-231</div>`},
{id:1109,codigo:"s-232",q:"¿Qué indica la señal S-232?",a:["Carriles con direcciones obligatorias","Carriles libres","Prohibido cambiar carril"],ok:0,subtema:"Senyals Carrils",pag:52,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-232</div>`},
{id:1110,codigo:"s-233",q:"¿Qué indica la señal S-233?",a:["Carriles con direcciones obligatorias","Carriles libres","Prohibido cambiar carril"],ok:0,subtema:"Senyals Carrils",pag:52,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-233</div>`},
{id:1111,codigo:"s-234",q:"¿Qué indica la señal S-234?",a:["Carriles con direcciones obligatorias","Carriles libres","Prohibido cambiar carril"],ok:0,subtema:"Senyals Carrils",pag:52,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-234</div>`},
{id:1112,codigo:"s-235",q:"¿Qué indica la señal S-235?",a:["Carriles con direcciones obligatorias","Carriles libres","Prohibido cambiar carril"],ok:0,subtema:"Senyals Carrils",pag:52,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-235</div>`},
{id:1113,codigo:"s-236",q:"¿Qué indica la señal S-236?",a:["Carriles con direcciones obligatorias","Carriles libres","Prohibido cambiar carril"],ok:0,subtema:"Senyals Carrils",pag:52,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-236</div>`},
{id:1114,codigo:"s-237",q:"¿Qué indica la señal S-237?",a:["Carriles con direcciones obligatorias","Carriles libres","Prohibido cambiar carril"],ok:0,subtema:"Senyals Carrils",pag:52,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-237</div>`},
{id:1115,codigo:"s-238",q:"¿Qué indica la señal S-238?",a:["Carriles con direcciones obligatorias","Carriles libres","Prohibido cambiar carril"],ok:0,subtema:"Senyals Carrils",pag:52,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-238</div>`},
{id:1116,codigo:"s-239",q:"¿Qué indica la señal S-239?",a:["Carriles con direcciones obligatorias","Carriles libres","Prohibido cambiar carril"],ok:0,subtema:"Senyals Carrils",pag:52,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-239</div>`},
{id:1117,codigo:"s-240",q:"¿Qué indica la señal S-240?",a:["Carril de aceleración","Carril de deceleración","Prohibido incorporar"],ok:0,subtema:"Senyals Carrils",pag:52,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-240</div>`},
{id:1118,codigo:"s-241",q:"¿Qué indica la señal S-241?",a:["Carril de aceleración","Carril de deceleración","Prohibido salir"],ok:0,subtema:"Senyals Carrils",pag:52,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-241</div>`},
{id:1119,codigo:"s-200",q:"¿Qué indica la señal S-200?",a:["Calle sin salida","Dirección obligatoria","Prohibido pasar"],ok:0,subtema:"Senyals Direcció",pag:53,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-200</div>`},
{id:1120,codigo:"s-201",q:"¿Qué indica la señal S-201?",a:["Ruta recomendada para camiones","Prohibido camiones","Taller camiones"],ok:0,subtema:"Senyals Direcció",pag:53,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-201</div>`},
{id:1121,codigo:"s-202",q:"¿Qué indica la señal S-202?",a:["Ruta recomendada para camiones","Prohibido camiones","Taller camiones"],ok:0,subtema:"Senyals Direcció",pag:53,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-202</div>`},
{id:1122,codigo:"s-203",q:"¿Qué indica la señal S-203?",a:["Ruta recomendada para camiones","Prohibido camiones","Taller camiones"],ok:0,subtema:"Senyals Direcció",pag:53,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-203</div>`},
{id:1123,codigo:"s-204",q:"¿Qué indica la señal S-204?",a:["Ruta recomendada para camiones","Prohibido camiones","Taller camiones"],ok:0,subtema:"Senyals Direcció",pag:53,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-204</div>`},
{id:1124,codigo:"s-205",q:"¿Qué indica la señal S-205?",a:["Ruta recomendada para camiones","Prohibido camiones","Taller camiones"],ok:0,subtema:"Senyals Direcció",pag:53,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-205</div>`},
{id:1125,codigo:"s-206",q:"¿Qué significa la señal S-206?",a:["Ruta recomendada para camiones","Prohibido camiones","Taller camiones"],ok:0,subtema:"Senyals Direcció",pag:53,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-206</div>`},
{id:1126,codigo:"s-207",q:"¿Qué significa la señal S-207?",a:["Ruta recomendada para camiones","Prohibido camiones","Taller camiones"],ok:0,subtema:"Senyals Direcció",pag:53,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-207</div>`},
{id:1127,codigo:"s-208",q:"¿Qué significa la señal S-208?",a:["Ruta recomendada para camiones","Prohibido camiones","Taller camiones"],ok:0,subtema:"Senyals Direcció",pag:53,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-208</div>`},
{id:1128,codigo:"s-209",q:"¿Qué significa la señal S-209?",a:["Ruta recomendada para camiones","Prohibido camiones","Taller camiones"],ok:0,subtema:"Senyals Direcció",pag:53,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-209</div>`},
{id:1129,codigo:"s-210",q:"¿Qué indica la señal S-210?",a:["Prohibido bicis","Carril bici","Zona peatonal"],ok:1,subtema:"Senyals Direcció",pag:53,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-210</div>`},
{id:1130,codigo:"s-211",q:"¿Qué indica la señal S-211?",a:["Prohibido peatones","Zona peatonal","Carril bici"],ok:1,subtema:"Senyals Direcció",pag:53,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-211</div>`},
{id:1131,codigo:"s-212",q:"¿Qué indica la señal S-212?",a:["Prohibido bicis","Carril bici","Zona peatonal"],ok:1,subtema:"Senyals Direcció",pag:53,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-212</div>`},
{id:1132,codigo:"s-213",q:"¿Qué indica la señal S-213?",a:["Prohibido peatones","Zona peatonal","Carril bici"],ok:1,subtema:"Senyals Direcció",pag:53,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-213</div>`},
{id:1133,codigo:"s-214",q:"¿Qué indica la señal S-214?",a:["Prohibido bicis","Carril bici","Zona peatonal"],ok:1,subtema:"Senyals Direcció",pag:53,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-214</div>`},
{id:1134,codigo:"s-215",q:"¿Qué indica la señal S-215?",a:["Prohibido peatones","Zona peatonal","Carril bici"],ok:1,subtema:"Senyals Direcció",pag:53,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-215</div>`},
{id:1135,codigo:"s-216",q:"¿Qué indica la señal S-216?",a:["Prohibido bicis","Carril bici","Zona peatonal"],ok:1,subtema:"Senyals Direcció",pag:53,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-216</div>`},
{id:1136,codigo:"s-217",q:"¿Qué indica la señal S-217?",a:["Prohibido peatones","Zona peatonal","Carril bici"],ok:1,subtema:"Senyals Direcció",pag:53,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-217</div>`},
{id:1137,codigo:"s-218",q:"¿Qué indica la señal S-218?",a:["Prohibido bicis","Carril bici","Zona peatonal"],ok:1,subtema:"Senyals Direcció",pag:53,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-218</div>`},
{id:1138,codigo:"s-219",q:"¿Qué indica la señal S-219?",a:["Prohibido peatones","Zona peatonal","Carril bici"],ok:1,subtema:"Senyals Direcció",pag:53,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-219</div>`},
{id:1139,codigo:"s-220",q:"¿Qué indica la señal S-220?",a:["Salida derecha","Desvío obligatorio derecha","Prohibido girar derecha"],ok:0,subtema:"Senyals Direcció",pag:53,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-220</div>`},
{id:1140,codigo:"s-370",q:"¿Qué indica la señal S-370?",a:["Preseñalización de dirección","Información general","Prohibición"],ok:0,subtema:"Senyals Preseñalització",pag:54,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-370</div>`},
{id:1141,codigo:"s-371",q:"¿Qué indica la señal S-371?",a:["Preseñalización de dirección","Información general","Prohibición"],ok:0,subtema:"Senyals Preseñalització",pag:54,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-371</div>`},
{id:1142,codigo:"s-372",q:"¿Qué indica la señal S-372?",a:["Preseñalización de dirección","Información general","Prohibición"],ok:0,subtema:"Senyals Preseñalització",pag:54,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-372</div>`},
{id:1143,codigo:"s-373",q:"¿Qué indica la señal S-373?",a:["Preseñalización de dirección","Información general","Prohibición"],ok:0,subtema:"Senyals Preseñalització",pag:54,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-373</div>`},
{id:1144,codigo:"s-374",q:"¿Qué indica la señal S-374?",a:["Preseñalización de dirección","Información general","Prohibición"],ok:0,subtema:"Senyals Preseñalització",pag:54,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-374</div>`},
{id:1145,codigo:"s-375",q:"¿Qué indica la señal S-375?",a:["Preseñalización de dirección","Información general","Prohibición"],ok:0,subtema:"Senyals Preseñalització",pag:54,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-375</div>`},
{id:1146,codigo:"s-376",q:"¿Qué indica la señal S-376?",a:["Preseñalización de dirección","Información general","Prohibición"],ok:0,subtema:"Senyals Preseñalització",pag:54,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-376</div>`},
{id:1147,codigo:"s-377",q:"¿Qué indica la señal S-377?",a:["Preseñalización de dirección","Información general","Prohibición"],ok:0,subtema:"Senyals Preseñalització",pag:54,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-377</div>`},
{id:1148,codigo:"s-221",q:"¿Qué indica la señal S-221?",a:["Salida izquierda","Desvío obligatorio izquierda","Prohibido girar izquierda"],ok:0,subtema:"Senyals Direcció",pag:53,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-221</div>`},
{id:1149,codigo:"s-222",q:"¿Qué indica la señal S-222?",a:["Solo recto","Desvío obligatorio de frente","Prohibido recto"],ok:0,subtema:"Senyals Direcció",pag:53,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-222</div>`},
{id:1150,codigo:"s-223",q:"¿Qué indica la señal S-223?",a:["Solo giro","Direcciones obligatorias derecha o izquierda","Prohibido girar"],ok:1,subtema:"Senyals Direcció",pag:53,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-223</div>`},
{id:1151,codigo:"s-224",q:"¿Qué indica la señal S-224?",a:["Solo recto","Direcciones obligatorias recto o derecha","Prohibido derecha"],ok:1,subtema:"Senyals Direcció",pag:53,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-224</div>`},
{id:1152,codigo:"s-225",q:"¿Qué indica la señal S-225?",a:["Solo recto","Direcciones obligatorias recto o izquierda","Prohibido izquierda"],ok:1,subtema:"Senyals Direcció",pag:53,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-225</div>`},
{id:1153,codigo:"s-226",q:"¿Qué indica la señal S-226?",a:["Solo giro","Direcciones obligatorias derecha o izquierda","Prohibido girar"],ok:1,subtema:"Senyals Direcció",pag:53,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-226</div>`},
{id:1154,codigo:"s-227",q:"¿Qué indica la señal S-227?",a:["Prohibido rotonda","Sentido giratorio obligatorio","Ceda el paso"],ok:1,subtema:"Senyals Direcció",pag:53,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-227</div>`},
{id:1155,codigo:"s-228",q:"¿Qué indica la señal S-228?",a:["Prohibido rotonda","Sentido giratorio obligatorio","Ceda el paso"],ok:1,subtema:"Senyals Direcció",pag:53,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-228</div>`},
{id:1156,codigo:"s-229",q:"¿Qué indica la señal S-229?",a:["Prohibido rotonda","Sentido giratorio obligatorio","Ceda el paso"],ok:1,subtema:"Senyals Direcció",pag:53,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-229</div>`},
{id:1157,codigo:"s-320",q:"¿Qué indica la señal S-320?",a:["Carretera nacional","Autopista A-1","Carretera comarcal"],ok:0,subtema:"Senyals Identificació",pag:55,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-320</div>`},
{id:1158,codigo:"s-330",q:"¿Qué indica la señal S-330?",a:["Autopista","Carretera nacional N-340","Carretera local"],ok:0,subtema:"Senyals Identificació",pag:55,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-330</div>`},
{id:1159,codigo:"s-340",q:"¿Qué indica la señal S-340?",a:["Carretera nacional","Autopista de peaje AP-7","Carretera comarcal"],ok:1,subtema:"Senyals Identificació",pag:55,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-340</div>`},
{id:1160,codigo:"s-350",q:"¿Qué indica la señal S-350?",a:["Carretera nacional","Itinerario europeo E-15","Carretera local"],ok:1,subtema:"Senyals Identificació",pag:55,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-350</div>`},
{id:1161,codigo:"s-351",q:"¿Qué indica la señal S-351?",a:["Carretera nacional","Itinerario europeo E-90","Carretera local"],ok:1,subtema:"Senyals Identificació",pag:55,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-351</div>`},
{id:1162,codigo:"s-352",q:"¿Qué indica la señal S-352?",a:["Carretera nacional","Itinerario europeo E-80","Carretera local"],ok:1,subtema:"Senyals Identificació",pag:55,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-352</div>`},
{id:1163,codigo:"s-500",q:"¿Qué indica la señal S-500?",a:["Fin población","Inicio de población con 20.000+ hab","Prohibido entrar población"],ok:0,subtema:"Senyals Localització",pag:56,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-500</div>`},
{id:1164,codigo:"s-510",q:"¿Qué indica la señal S-510?",a:["Inicio población","Fin de población","Prohibido entrar población"],ok:0,subtema:"Senyals Localització",pag:56,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-510</div>`},
{id:1165,codigo:"s-520",q:"¿Qué indica la señal S-520?",a:["Fin población","Inicio de población <5.000 hab","Prohibido entrar población"],ok:0,subtema:"Senyals Localització",pag:56,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-520</div>`},
{id:1166,codigo:"s-521",q:"¿Qué indica la señal S-521?",a:["Inicio población","Fin de población <5.000 hab","Prohibido entrar población"],ok:0,subtema:"Senyals Localització",pag:56,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-521</div>`},
{id:1167,codigo:"s-360",q:"¿Qué indica la señal S-360?",a:["Distancia a la próxima población","Velocidad recomendada","Prohibido entrar"],ok:0,subtema:"Senyals Confirmació",pag:57,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-360</div>`},
{id:1168,codigo:"s-361",q:"¿Qué indica la señal S-361?",a:["Distancia a población","Nombre población","Velocidad máxima"],ok:0,subtema:"Senyals Confirmació",pag:57,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-361</div>`},
{id:1169,codigo:"s-362",q:"¿Qué indica la señal S-362?",a:["Distancia a población","Nombre población","Velocidad máxima"],ok:0,subtema:"Senyals Confirmació",pag:57,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-362</div>`},
{id:1170,codigo:"s-363",q:"¿Qué indica la señal S-363?",a:["Distancia a población","Nombre población","Velocidad máxima"],ok:0,subtema:"Senyals Confirmació",pag:57,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-363</div>`},
{id:1171,codigo:"s-364",q:"¿Qué indica la señal S-364?",a:["Distancia a población","Nombre población","Velocidad máxima"],ok:0,subtema:"Senyals Confirmació",pag:57,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-364</div>`},
{id:1172,codigo:"s-365",q:"¿Qué indica la señal S-365?",a:["Distancia a población","Nombre población","Velocidad máxima"],ok:0,subtema:"Senyals Confirmació",pag:57,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-365</div>`},
{id:1173,codigo:"s-366",q:"¿Qué indica la señal S-366?",a:["Distancia a población","Nombre población","Velocidad máxima"],ok:0,subtema:"Senyals Confirmació",pag:57,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-366</div>`},
{id:1174,codigo:"s-367",q:"¿Qué indica la señal S-367?",a:["Distancia a población","Nombre población","Velocidad máxima"],ok:0,subtema:"Senyals Confirmació",pag:57,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-367</div>`},
{id:1175,codigo:"s-368",q:"¿Qué indica la señal S-368?",a:["Distancia a población","Nombre población","Velocidad máxima"],ok:0,subtema:"Senyals Confirmació",pag:57,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-368</div>`},
{id:1176,codigo:"s-369",q:"¿Qué indica la señal S-369?",a:["Distancia a población","Nombre población","Velocidad máxima"],ok:0,subtema:"Senyals Confirmació",pag:57,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-369</div>`},
{id:1177,codigo:"s-440",q:"¿Qué indica la señal S-440?",a:["Zona peatonal","Zona residencial","Prohibido circular"],ok:1,subtema:"Senyals Població",pag:58,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-440</div>`},
{id:1178,codigo:"s-441",q:"¿Qué indica la señal S-441?",a:["Inicio zona residencial","Fin de zona residencial","Zona peatonal"],ok:0,subtema:"Senyals Població",pag:58,img:`<div style="background:#0099ff;color:white;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-441</div>`},
{id:1179,codigo:"s-880",q:"¿Qué indica el panel S-880?",a:["Panel decorativo","Panel con texto complementario al peligro próximo","No sirve"],ok:1,subtema:"Panells Complementaris",pag:59,img:`<div style="background:white;color:#000;border:3px solid #000;font-size:40px;font-weight:900;display:flex;align-items:center;justify-content:center;height:100%;border-radius:12px">S-880</div>`},
],
