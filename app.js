...
const PREGUNTES = {
 ...
 senyals: [
  // === 3.2 PRIORITAT R-1 A R-6 ===
  {id:1,q:"El senyal R-1 Què indica?",a:["Stop","Cedeixi el pas","Prohibit entrar"],ok:0,codigo:"r-1",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,50 190,150 100,190 10,150 10,50" fill="#D32F2F" stroke="#000" stroke-width="6"/><text x="100" y="120" fill="white" font-size="60" font-weight="900" text-anchor="middle">STOP</text></svg>`},
  {id:2,q:"El senyal R-2 Què indica?",a:["Cedeixi el pas","Parada obligatòria total","Cedeixi a la intersecció"],ok:0,codigo:"r-2",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#fff" stroke="#D32F2F" stroke-width="8"/><text x="100" y="155" fill="#D32F2F" font-size="38" font-weight="900" text-anchor="middle">CEDA</text></svg>`},
  {id:3,q:"El senyal R-3 Què indica?",a:["Fi de prioritat","Calçada amb prioritat","Intersecció amb prioritat"],ok:1,codigo:"r-3",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#fff" stroke="#000" stroke-width="4"/><path d="M100 20 L100 180 M20 100 L180 100" stroke="#000" stroke-width="8"/><rect x="90" y="90" width="20" height="20" fill="#000"/></svg>`},
  {id:4,q:"El senyal R-4 Què indica?",a:["Inici de prioritat","Fi de calçada amb prioritat","Cedeixi el pas"],ok:1,codigo:"r-4",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#fff" stroke="#000" stroke-width="4"/><path d="M100 20 L100 180 M20 100 L180 100" stroke="#000" stroke-width="8"/><line x1="90" y1="90" x2="110" y2="110" stroke="#000" stroke-width="6"/></svg>`},
  {id:5,q:"El senyal R-5 Què indica?",a:["Vostè té prioritat","Prioritat per al sentit contrari","Stop obligatori"],ok:0,codigo:"r-5",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#fff" stroke="#000" stroke-width="4"/><rect x="55" y="55" width="90" height="90" fill="#000"/><polygon points="100,70 130,100 100,130 70,100" fill="#fff"/></svg>`},
  {id:6,q:"El senyal R-6 Què indica?",a:["Cedeixi el pas","Té prioritat respecte al sentit contrari","Prohibit passar"],ok:1,codigo:"r-6",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#fff" stroke="#000" stroke-width="4"/><rect x="55" y="55" width="90" height="90" fill="#000"/><rect x="65" y="65" width="70" height="70" fill="#fff"/></svg>`},

  // === 3.3 PROHIBICIÓ ENTRADA R-101 A R-116 ===
  {id:7,q:"El senyal R-101 Què prohibeix?",a:["Obligació de girar","Prohibició d'entrada a tota classe de vehicles","Fi de prohibicions"],ok:1,codigo:"r-101",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#D32F2F" stroke="#000" stroke-width="4"/><rect x="40" y="90" width="120" height="20" fill="#fff"/></svg>`},
  {id:8,q:"El senyal R-102 Què prohibeix?",a:["Prohibida l'entrada a bicicletes","Prohibida l'entrada a vehicles de motor","Prohibida l'entrada a vianants"],ok:1,codigo:"r-102",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#D32F2F" stroke="#000" stroke-width="4"/><circle cx="70" cy="130" r="12" fill="#fff"/><circle cx="130" cy="130" r="12" fill="#fff"/><rect x="70" y="95" width="60" height="6" fill="#fff"/><rect x="96" y="75" width="8" height="28" fill="#fff"/><line x1="25" y1="25" x2="175" y2="175" stroke="#fff" stroke-width="12"/></svg>`},
  {id:9,q:"El senyal R-103 Què prohibeix?",a:["Prohibida l'entrada a turismes","Prohibida l'entrada a camions","Prohibida l'entrada a autobusos"],ok:0,codigo:"r-103",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#D32F2F" stroke="#000" stroke-width="4"/><rect x="60" y="80" width="80" height="40" fill="#fff"/><circle cx="75" cy="125" r="9" fill="#000"/><circle cx="125" cy="125" r="9" fill="#000"/><line x1="25" y1="25" x2="175" y2="175" stroke="#fff" stroke-width="12"/></svg>`},
  {id:10,q:"El senyal R-104 Què prohibeix?",a:["Prohibida l'entrada a ciclomotors","Prohibida l'entrada a motocicletes","Prohibida l'entrada a turismes"],ok:1,codigo:"r-104",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#D32F2F" stroke="#000" stroke-width="4"/><circle cx="80" cy="120" r="10" fill="#fff"/><circle cx="120" cy="120" r="10" fill="#fff"/><rect x="80" y="95" width="40" height="5" fill="#fff"/><line x1="25" y1="25" x2="175" y2="175" stroke="#fff" stroke-width="12"/></svg>`},
  {id:11,q:"El senyal R-105 Què prohibeix?",a:["Prohibida l'entrada a turismes","Prohibida l'entrada a camions","Prohibida l'entrada a autobusos"],ok:1,codigo:"r-105",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#D32F2F" stroke="#000" stroke-width="4"/><rect x="50" y="75" width="100" height="50" fill="#fff"/><rect x="40" y="125" width="120" height="12" fill="#fff"/><line x1="25" y1="25" x2="175" y2="175" stroke="#fff" stroke-width="12"/></svg>`},
  {id:12,q:"El senyal R-106 Què prohibeix?",a:["Prohibida l'entrada a camions","Prohibida l'entrada a autobusos","Prohibida l'entrada a taxis"],ok:0,codigo:"r-106",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#D32F2F" stroke="#000" stroke-width="4"/><rect x="45" y="75" width="110" height="50" fill="#fff"/><line x1="25" y1="25" x2="175" y2="175" stroke="#fff" stroke-width="12"/></svg>`},
  {id:13,q:"El senyal R-107 Què prohibeix?",a:["Prohibida l'entrada a motocicletes","Prohibida l'entrada a bicicletes","Prohibida l'entrada a vianants"],ok:2,codigo:"r-107",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#D32F2F" stroke="#000" stroke-width="4"/><circle cx="100" cy="100" r="30" fill="#fff"/><line x1="25" y1="25" x2="175" y2="175" stroke="#fff" stroke-width="12"/></svg>`},
  {id:14,q:"El senyal R-108 Què prohibeix?",a:["Prohibida l'entrada a bicicletes","Prohibida l'entrada a ciclomotors","Prohibida l'entrada a motocicletes"],ok:0,codigo:"r-108",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#D32F2F" stroke="#000" stroke-width="4"/><circle cx="70" cy="130" r="12" fill="#fff"/><circle cx="130" cy="130" r="12" fill="#fff"/><rect x="70" y="95" width="60" height="6" fill="#fff"/><rect x="96" y="75" width="8" height="28" fill="#fff"/><line x1="25" y1="25" x2="175" y2="175" stroke="#fff" stroke-width="12"/></svg>`},
  {id:15,q:"El senyal R-109 Què prohibeix?",a:["Prohibida l'entrada a vehicles agrícoles","Prohibida l'entrada a turismes","Prohibida l'entrada a autobusos"],ok:0,codigo:"r-109",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#D32F2F" stroke="#000" stroke-width="4"/><rect x="50" y="80" width="100" height="40" fill="#fff"/><circle cx="65" cy="125" r="8" fill="#000"/><circle cx="135" cy="125" r="8" fill="#000"/><line x1="25" y1="25" x2="175" y2="175" stroke="#fff" stroke-width="12"/></svg>`},
  {id:16,q:"El senyal R-110 Què prohibeix?",a:["Prohibida l'entrada a carros de mà","Prohibida l'entrada a vianants","Prohibida l'entrada a bicicletes"],ok:0,codigo:"r-110",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#D32F2F" stroke="#000" stroke-width="4"/><rect x="70" y="90" width="60" height="20" fill="#fff"/><line x1="25" y1="25" x2="175" y2="175" stroke="#fff" stroke-width="12"/></svg>`},
  {id:17,q:"El senyal R-111 Què prohibeix?",a:["Prohibida l'entrada a camions","Prohibida l'entrada a vehicles agrícoles","Prohibida l'entrada a autobusos"],ok:1,codigo:"r-111",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#D32F2F" stroke="#000" stroke-width="4"/><rect x="50" y="80" width="100" height="40" fill="#fff"/><circle cx="65" cy="125" r="8" fill="#000"/><circle cx="135" cy="125" r="8" fill="#000"/><line x1="25" y1="25" x2="175" y2="175" stroke="#fff" stroke-width="12"/></svg>`},
  {id:18,q:"El senyal R-112 Què prohibeix?",a:["Prohibida l'entrada a vianants","Prohibida l'entrada a animals de muntura","Prohibida l'entrada a bicicletes"],ok:1,codigo:"r-112",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#D32F2F" stroke="#000" stroke-width="4"/><path d="M80 90 Q100 70 120 90" stroke="#fff" stroke-width="8" fill="none"/><line x1="25" y1="25" x2="175" y2="175" stroke="#fff" stroke-width="12"/></svg>`},
  {id:19,q:"El senyal R-113 Què prohibeix?",a:["Prohibida l'entrada a vianants","Prohibida l'entrada a carros de mà","Prohibida l'entrada a bicicletes"],ok:0,codigo:"r-113",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#D32F2F" stroke="#000" stroke-width="4"/><circle cx="100" cy="100" r="30" fill="#fff"/><line x1="25" y1="25" x2="175" y2="175" stroke="#fff" stroke-width="12"/></svg>`},
  {id:20,q:"El senyal R-114 Què prohibeix?",a:["Prohibida l'entrada a bicicletes","Prohibida l'entrada a vianants","Prohibida l'entrada a motos"],ok:0,codigo:"r-114",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#D32F2F" stroke="#000" stroke-width="4"/><circle cx="70" cy="130" r="12" fill="#fff"/><circle cx="130" cy="130" r="12" fill="#fff"/><rect x="70" y="95" width="60" height="6" fill="#fff"/><rect x="96" y="75" width="8" height="28" fill="#fff"/><line x1="25" y1="25" x2="175" y2="175" stroke="#fff" stroke-width="12"/></svg>`},
  {id:21,q:"El senyal R-115 Què prohibeix?",a:["Prohibida l'entrada a animals solts","Prohibida l'entrada a vianants","Prohibida l'entrada a bicicletes"],ok:0,codigo:"r-115",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#D32F2F" stroke="#000" stroke-width="4"/><circle cx="100" cy="100" r="30" fill="#fff"/><line x1="25" y1="25" x2="175" y2="175" stroke="#fff" stroke-width="12"/></svg>`},
  {id:22,q:"El senyal R-116 Què prohibeix?",a:["Prohibida l'entrada a vianants","Prohibida l'entrada a animals solts","Prohibida l'entrada a bicicletes"],ok:1,codigo:"r-116",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#D32F2F" stroke="#000" stroke-width="4"/><circle cx="100" cy="100" r="30" fill="#fff"/><line x1="25" y1="25" x2="175" y2="175" stroke="#fff" stroke-width="12"/></svg>`},

  // === 3.5 ALTRES PROHIBICIÓ R-300 A R-311 ===
  {id:23,q:"El senyal R-300 Què indica?",a:["Velocitat mínima 50 km/h","Velocitat màxima 50 km/h","Velocitat recomanada 50 km/h"],ok:1,codigo:"r-300",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#fff" stroke="#000" stroke-width="6"/><text x="100" y="128" fill="#000" font-size="85" font-weight="900" text-anchor="middle">50</text></svg>`},
  {id:24,q:"El senyal R-301 Què indica?",a:["Inici limitació 50","Fi de limitació de velocitat màxima","Nova limitació 50"],ok:1,codigo:"r-301",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#fff" stroke="#000" stroke-width="6"/><text x="100" y="128" fill="#000" font-size="85" font-weight="900" text-anchor="middle">50</text><line x1="25" y1="25" x2="175" y2="175" stroke="#000" stroke-width="8"/></svg>`},
  {id:25,q:"El senyal R-302 Què prohibeix?",a:["Gir esquerra permès","Prohibit girar a l'esquerra","Obligatori girar esquerra"],ok:1,codigo:"r-302",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#fff" stroke="#000" stroke-width="6"/><path d="M100 60 L100 140 L60 120" stroke="#000" stroke-width="8" fill="none"/><line x1="25" y1="25" x2="175" y2="175" stroke="#D32F2F" stroke-width="10"/></svg>`},
  {id:26,q:"El senyal R-303 Què prohibeix?",a:["Gir dreta permès","Prohibit girar a la dreta","Obligatori girar dreta"],ok:1,codigo:"r-303",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#fff" stroke="#000" stroke-width="6"/><path d="M100 60 L100 140 L140 120" stroke="#000" stroke-width="8" fill="none"/><line x1="25" y1="25" x2="175" y2="175" stroke="#D32F2F" stroke-width="10"/></svg>`},
  {id:27,q:"El senyal R-304 Què prohibeix?",a:["Canvi de sentit permès","Prohibit efectuar canvi de sentit","Obligatori canvi de sentit"],ok:1,codigo:"r-304",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#fff" stroke="#000" stroke-width="6"/><path d="M70 100 A30 30 0 1 1 130 100" stroke="#000" stroke-width="8" fill="none"/><line x1="25" y1="25" x2="175" y2="175" stroke="#D32F2F" stroke-width="10"/></svg>`},
  {id:28,q:"El senyal R-305 Què prohibeix?",a:["Avançament permès","Prohibit avançar","Obligatori avançar"],ok:1,codigo:"r-305",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#fff" stroke="#000" stroke-width="6"/><rect x="60" y="85" width="30" height="30" fill="#000"/><rect x="110" y="85" width="30" height="30" fill="#D32F2F"/><line x1="25" y1="25" x2="175" y2="175" stroke="#D32F2F" stroke-width="10"/></svg>`},
  {id:29,q:"El senyal R-306 Què indica?",a:["Inici prohibició","Fi de prohibició d'avançar","Avançament obligatori"],ok:1,codigo:"r-306",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#fff" stroke="#000" stroke-width="6"/><rect x="60" y="85" width="30" height="30" fill="#000"/><rect x="110" y="85" width="30" height="30" fill="#D32F2F"/><line x1="25" y1="25" x2="175" y2="175" stroke="#000" stroke-width="8"/></svg>`},
  {id:30,q:"El senyal R-307 Què prohibeix?",a:["Prohibit als turismes avançar","Prohibit avançar a camions","Prohibit als autobusos avançar"],ok:1,codigo:"r-307",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#fff" stroke="#000" stroke-width="6"/><rect x="55" y="80" width="90" height="40" fill="#000"/><line x1="25" y1="25" x2="175" y2="175" stroke="#D32F2F" stroke-width="10"/></svg>`},
  {id:31,q:"El senyal R-308 Què indica?",a:["Inici prohibició camions","Fi de prohibició d'avançar a camions","Els turismes poden avançar"],ok:1,codigo:"r-308",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#fff" stroke="#000" stroke-width="6"/><rect x="55" y="80" width="90" height="40" fill="#000"/><line x1="25" y1="25" x2="175" y2="175" stroke="#000" stroke-width="8"/></svg>`},
  {id:32,q:"El senyal R-309 Què indica?",a:["Zona d'avançament permès","Zona amb prohibició d'avançar","Fi de prohibició d'avançar"],ok:1,codigo:"r-309",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#fff" stroke="#000" stroke-width="6"/><rect x="60" y="85" width="30" height="30" fill="#000"/><rect x="110" y="85" width="30" height="30" fill="#D32F2F"/></svg>`},
  {id:33,q:"El senyal R-310 Què prohibeix?",a:["Ús obligatori del clàxon","Prohibit l'ús de senyals acústiques","Fi de prohibició del clàxon"],ok:1,codigo:"r-310",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#fff" stroke="#000" stroke-width="6"/><path d="M80 100 Q100 80 120 100" stroke="#000" stroke-width="6" fill="none"/><line x1="25" y1="25" x2="175" y2="175" stroke="#D32F2F" stroke-width="10"/></svg>`},
  {id:34,q:"El senyal R-311 Què indica?",a:["Velocitat mínima 30 km/h","Velocitat màxima 30 km/h","Fi de velocitat mínima"],ok:0,codigo:"r-311",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#fff" stroke="#000" stroke-width="6"/><text x="100" y="128" fill="#000" font-size="85" font-weight="900" text-anchor="middle">30</text></svg>`},

  // === 3.6 OBLIGACIÓ R-400 A R-422 ===
  {id:35,q:"El senyal R-400 Què obliga?",a:["Prohibició","Sentit obligatori","Fi d'obligació"],ok:1,codigo:"r-400",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><path d="M100 60 L100 140" stroke="#fff" stroke-width="10"/></svg>`},
  {id:36,q:"El senyal R-401 Què obliga?",a:["Prohibit girar a la dreta","Sentit obligatori a la dreta","Gir a la dreta recomanat"],ok:1,codigo:"r-401",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><path d="M100 60 L100 120 L140 100" stroke="#fff" stroke-width="10" fill="none"/></svg>`},
  {id:37,q:"El senyal R-402 Què obliga?",a:["Prohibit girar a l'esquerra","Sentit obligatori a l'esquerra","Gir a l'esquerra recomanat"],ok:1,codigo:"r-402",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><path d="M100 60 L100 120 L60 100" stroke="#fff" stroke-width="10" fill="none"/></svg>`},
  {id:38,q:"El senyal R-403 Què obliga?",a:["Prohibit passar per la dreta","Pas obligatori per la dreta de l'obstacle","Fi d'obligació"],ok:1,codigo:"r-403",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><circle cx="100" cy="100" r="30" fill="#fff"/><path d="M100 60 L100 140" stroke="#005EB8" stroke-width="10"/></svg>`},
  {id:39,q:"El senyal R-404 Què obliga?",a:["Prohibit passar per l'esquerra","Pas obligatori per l'esquerra de l'obstacle","Fi d'obligació"],ok:1,codigo:"r-404",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><circle cx="100" cy="100" r="30" fill="#fff"/><path d="M100 60 L100 140" stroke="#005EB8" stroke-width="10"/></svg>`},
  {id:40,q:"El senyal R-405 Què obliga?",a:["Gir obligatori","Sentit obligatori de front","Prohibit recte"],ok:1,codigo:"r-405",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><path d="M100 60 L100 140 L140 120 M100 140 L60 120" stroke="#fff" stroke-width="10" fill="none"/></svg>`},
  {id:41,q:"El senyal R-406 Què obliga?",a:["Prohibit recte","Sentit obligatori a la dreta o esquerra","Obligatori girar"],ok:1,codigo:"r-406",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><path d="M100 140 L140 120 M100 140 L60 120" stroke="#fff" stroke-width="10" fill="none"/></svg>`},
  {id:42,q:"El senyal R-407 Què indica?",a:["Prohibit encendre llums","Via obligatòria per a ciclistes","Via recomanada per a ciclistes"],ok:1,codigo:"r-407",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><circle cx="70" cy="125" r="14" fill="#fff"/><circle cx="130" cy="125" r="14" fill="#fff"/><rect x="70" y="95" width="60" height="7" fill="#fff"/><rect x="96" y="75" width="8" height="28" fill="#fff"/></svg>`},
  {id:43,q:"El senyal R-408 Què indica?",a:["Prohibit vianants","Via obligatòria per a vianants","Només bicicletes"],ok:1,codigo:"r-408",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><circle cx="100" cy="90" r="11" fill="#fff"/><rect x="95" y="105" width="10" height="28" fill="#fff"/><rect x="77" y="133" width="13" height="9" fill="#fff"/><rect x="110" y="133" width="13" height="9" fill="#fff"/></svg>`},
  {id:44,q:"El senyal R-409 Què indica?",a:["Prohibit vianants","Via obligatòria per a vianants i cicles","Només vianants"],ok:1,codigo:"r-409",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><circle cx="80" cy="90" r="10" fill="#fff"/><rect x="76" y="105" width="8" height="25" fill="#fff"/><circle cx="120" cy="90" r="10" fill="#fff"/><rect x="116" y="105" width="8" height="25" fill="#fff"/></svg>`},
  {id:45,q:"El senyal R-410 Què indica?",a:["Prohibit vianants","Via obligatòria per a vianants i cicles","Només vianants"],ok:1,codigo:"r-410",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><circle cx="80" cy="90" r="10" fill="#fff"/><rect x="76" y="105" width="8" height="25" fill="#fff"/><circle cx="120" cy="90" r="10" fill="#fff"/><rect x="116" y="105" width="8" height="25" fill="#fff"/></svg>`},
  {id:46,q:"El senyal R-411 Què indica?",a:["Velocitat màxima 30","Velocitat mínima 30 km/h","Fi de velocitat mínima"],ok:1,codigo:"r-411",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="128" fill="#fff" font-size="85" font-weight="900" text-anchor="middle">30</text></svg>`},
  {id:47,q:"El senyal R-412 Què indica?",a:["Inici velocitat mínima","Fi de velocitat mínima","Nova velocitat mínima"],ok:0,codigo:"r-412",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="128" fill="#fff" font-size="85" font-weight="900" text-anchor="middle">30</text></svg>`},
  {id:48,q:"El senyal R-413 Què obliga?",a:["Prohibit encendre llums","Ús obligatori de l'enllumenat de creuament","Llums recomanades"],ok:1,codigo:"r-413",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><circle cx="100" cy="100" r="50" fill="#fff"/><path d="M70 100 L50 70 M130 100 L150 70" stroke="#fff" stroke-width="6"/></svg>`},
  {id:49,q:"El senyal R-414 Què indica?",a:["Inici obligació llums","Fi d'ús obligatori de l'enllumenat de creuament","Llums prohibides"],ok:1,codigo:"r-414",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><circle cx="100" cy="100" r="50" fill="#fff"/><path d="M70 100 L50 70 M130 100 L150 70" stroke="#fff" stroke-width="6"/></svg>`},
  {id:50,q:"El senyal R-415 Què obliga?",a:["Prohibit cadenes","Cadenes per a neu obligatòries","Cadenes recomanades"],ok:1,codigo:"r-415",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><path d="M55 95 Q70 115 100 80 Q130 115 145 95" stroke="#fff" stroke-width="9" fill="none" stroke-linecap="round"/><path d="M55 115 Q70 95 100 130 Q130 95 145 115" stroke="#fff" stroke-width="9" fill="none" stroke-linecap="round"/></svg>`},
 {id:51,q:"El senyal R-416 Què indica?",a:["Inici cadenes","Fi de cadenes per a neu obligatòries","Cadenes recomanades"],ok:1,codigo:"r-416",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><path d="M55 95 Q70 115 100 80 Q130 115 145 95" stroke="#fff" stroke-width="9" fill="none" stroke-linecap="round"/><path d="M55 115 Q70 95 100 130 Q130 95 145 115" stroke="#fff" stroke-width="9" fill="none" stroke-linecap="round"/></svg>`},
{id:52,q:"El senyal R-417 Què obliga?",a:["Prohibit cinturó","Ús obligatori del cinturó de seguretat","Cinturó recomanat"],ok:1,codigo:"r-417",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><rect x="60" y="80" width="80" height="40" fill="#fff"/><rect x="60" y="80" width="80" height="10" fill="#005EB8"/></svg>`},
{id:53,q:"El senyal R-418 Què indica?",a:["Prohibit cotxes","Via reservada per a automòbils","Via recomanada cotxes"],ok:1,codigo:"r-418",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><rect x="60" y="80" width="80" height="40" fill="#fff"/><circle cx="75" cy="125" r="9" fill="#000"/><circle cx="125" cy="125" r="9" fill="#000"/></svg>`},
{id:54,q:"El senyal R-419 Què indica?",a:["Prohibit camions","Via reservada per a camions","Via recomanada camions"],ok:1,codigo:"r-419",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><rect x="50" y="75" width="100" height="50" fill="#fff"/></svg>`},
{id:55,q:"El senyal R-420 Què indica?",a:["Prohibit autobusos","Via reservada per a autobusos","Via recomanada autobusos"],ok:1,codigo:"r-420",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><rect x="50" y="70" width="100" height="60" fill="#fff"/><rect x="60" y="80" width="20" height="20" fill="#005EB8"/><rect x="90" y="80" width="20" height="20" fill="#005EB8"/><rect x="120" y="80" width="20" height="20" fill="#005EB8"/></svg>`},
{id:56,q:"El senyal R-421 Què indica?",a:["Prohibit taxis","Via reservada per a taxis","Via recomanada taxis"],ok:1,codigo:"r-421",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><rect x="60" y="80" width="80" height="40" fill="#fff"/><text x="100" y="108" fill="#005EB8" font-size="20" font-weight="900" text-anchor="middle">TAXI</text></svg>`},
{id:57,q:"El senyal R-422 Què indica?",a:["Inici via reservada","Fi de via reservada per a automòbils","Via compartida"],ok:0,codigo:"r-422",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><rect x="60" y="80" width="80" height="40" fill="#fff"/></svg>`},

  // === 3.1 PERILL P-1 A P-50 ===
{id:58,q:"El senyal P-1 Què adverteix?",a:["Perill específic","Perill indefinit","Fi de perill"],ok:1,codigo:"p-1",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><text x="100" y="140" fill="#000" font-size="40" font-weight="900" text-anchor="middle">!</text></svg>`},
{id:59,q:"El senyal P-2 Què adverteix?",a:["Intersecció sense prioritat","Intersecció amb prioritat a la dreta","Cedeixi el pas"],ok:0,codigo:"p-2",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><path d="M100 60 L100 140 M60 100 L140 100" stroke="#000" stroke-width="6"/></svg>`},
{id:60,q:"El senyal P-3 Què adverteix?",a:["Semàfor apagat","Perill per proximitat de semàfors","Prohibit semàfors"],ok:1,codigo:"p-3",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><circle cx="100" cy="80" r="8" fill="#000"/><circle cx="100" cy="100" r="8" fill="#000"/><circle cx="100" cy="120" r="8" fill="#000"/></svg>`},
{id:61,q:"El senyal P-4 Què adverteix?",a:["Prohibit girar","Intersecció de sentit giratori obligatori","Cedeixi a la rotonda"],ok:1,codigo:"p-4",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><path d="M100 80 A20 20 0 1 1 100 120" stroke="#000" stroke-width="6" fill="none"/></svg>`},
{id:62,q:"El senyal P-13a Què adverteix?",a:["Corba suau dreta","Corba perillosa a la dreta","Gir obligatori dreta"],ok:1,codigo:"p-13a",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><path d="M70 140 Q100 80 130 140" stroke="#000" stroke-width="8" fill="none"/></svg>`},
{id:63,q:"El senyal P-13b Què adverteix?",a:["Corba suau esquerra","Corba perillosa a l'esquerra","Gir obligatori esquerra"],ok:1,codigo:"p-13b",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><path d="M130 140 Q100 80 70 140" stroke="#000" stroke-width="8" fill="none"/></svg>`},
{id:64,q:"El senyal P-14a Què adverteix?",a:["Corba única","Successió de corbes perilloses, primera a dreta","Prohibit corbar"],ok:1,codigo:"p-14a",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><path d="M70 140 Q90 100 110 140 Q130 180 150 140" stroke="#000" stroke-width="6" fill="none"/></svg>`},
{id:65,q:"El senyal P-14b Què adverteix?",a:["Corba única","Successió de corbes perilloses, primera a esquerra","Prohibit corbar"],ok:1,codigo:"p-14b",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><path d="M130 140 Q110 100 90 140 Q70 180 50 140" stroke="#000" stroke-width="6" fill="none"/></svg>`},
{id:66,q:"El senyal P-15 Què adverteix?",a:["Calçada llisa","Perfil irregular de la calçada, ressalts","Zona obres"],ok:1,codigo:"p-15",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><path d="M40 120 Q60 100 80 120 Q100 140 120 120 Q140 100 160 120" stroke="#000" stroke-width="6" fill="none"/></svg>`},
{id:67,q:"El senyal P-16a Què adverteix?",a:["Pujada amb pendent","Baixada amb fort pendent","Corba perillosa"],ok:1,codigo:"p-16a",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><path d="M50 140 L150 60" stroke="#000" stroke-width="8"/></svg>`},
{id:68,q:"El senyal P-16b Què adverteix?",a:["Baixada amb pendent","Pujada amb fort pendent","Corba perillosa"],ok:0,codigo:"p-16b",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><path d="M50 60 L150 140" stroke="#000" stroke-width="8"/></svg>`},
{id:69,q:"El senyal P-17 Què adverteix?",a:["Eixamplament calçada","Estretament de calçada","Pont estret"],ok:1,codigo:"p-17",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><path d="M60 80 L60 120 M140 80 L140 120 M80 90 L120 90 M80 110 L120 110" stroke="#000" stroke-width="6"/></svg>`},
{id:70,q:"El senyal P-20 Què adverteix?",a:["Prohibit vianants","Perill per proximitat de pas de vianants","Zona vianants"],ok:1,codigo:"p-20",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><circle cx="100" cy="88" r="11" fill="#000"/><rect x="95" y="105" width="10" height="28" fill="#000"/><rect x="77" y="133" width="13" height="9" fill="#000"/><rect x="110" y="133" width="13" height="9" fill="#000"/></svg>`},
{id:71,q:"El senyal P-21 Què adverteix?",a:["Zona escolar, perill per proximitat de nens","Parc infantil","Prohibit nens"],ok:0,codigo:"p-21",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><circle cx="85" cy="100" r="9" fill="#000"/><rect x="81" y="114" width="8" height="22" fill="#000"/><circle cx="115" cy="100" r="9" fill="#000"/><rect x="111" y="114" width="8" height="22" fill="#000"/></svg>`},
{id:72,q:"El senyal P-22 Què adverteix?",a:["Prohibit bicis","Perill per proximitat de ciclistes","Carril bici"],ok:1,codigo:"p-22",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><circle cx="70" cy="130" r="10" fill="#000"/><circle cx="130" cy="130" r="10" fill="#000"/><rect x="70" y="100" width="60" height="5" fill="#000"/><rect x="98" y="80" width="6" height="25" fill="#000"/></svg>`},
{id:73,q:"El senyal P-23 Què adverteix?",a:["Prohibit animals","Perill per proximitat d'animals domèstics","Granja"],ok:1,codigo:"p-23",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><circle cx="100" cy="100" r="20" fill="#000"/></svg>`},
{id:74,q:"El senyal P-24 Què adverteix?",a:["Prohibit caçar","Perill per proximitat d'animals salvatges","Zona zoo"],ok:1,codigo:"p-24",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><path d="M80 110 Q100 80 120 110" stroke="#000" stroke-width="6" fill="none"/></svg>`},
{id:75,q:"El senyal P-25 Què adverteix?",a:["Sentit únic","Circulació en ambdós sentits","Prohibit avançar"],ok:1,codigo:"p-25",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><path d="M100 70 L100 130 M80 110 L100 130 L120 110" stroke="#000" stroke-width="6" fill="none"/></svg>`},
{id:76,q:"El senyal P-26 Què adverteix?",a:["Zona segura","Zona amb despreniments","Prohibit parar"],ok:1,codigo:"p-26",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><path d="M60 140 L100 60 L140 140" stroke="#000" stroke-width="6" fill="none"/></svg>`},
{id:77,q:"El senyal P-27 Què adverteix?",a:["Calçada asfaltada","Perill per projecció de grava","Zona obres"],ok:1,codigo:"p-27",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><circle cx="80" cy="120" r="4" fill="#000"/><circle cx="100" cy="110" r="4" fill="#000"/><circle cx="120" cy="120" r="4" fill="#000"/></svg>`},
{id:78,q:"El senyal P-28 Què adverteix?",a:["Calçada asfaltada","Perill per projecció de grava","Zona obres"],ok:1,codigo:"p-28",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><circle cx="80" cy="120" r="4" fill="#000"/><circle cx="100" cy="110" r="4" fill="#000"/><circle cx="120" cy="120" r="4" fill="#000"/></svg>`},
{id:79,q:"El senyal P-29 Què adverteix?",a:["Vent frontal","Perill per vent lateral fort","Prohibit circular"],ok:1,codigo:"p-29",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><path d="M60 100 Q80 80 100 100 Q120 120 140 100" stroke="#000" stroke-width="6" fill="none"/></svg>`},
{id:80,q:"El senyal P-30 Què adverteix?",a:["Baden","Perill per graó lateral a la calçada","Zona obres"],ok:1,codigo:"p-30",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><rect x="60" y="120" width="80" height="10" fill="#000"/></svg>`},
{id:81,q:"El senyal P-31 Què adverteix?",a:["Via lliure","Perill per congestió de trànsit","Fi de congestió"],ok:1,codigo:"p-31",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><rect x="60" y="100" width="80" height="10" fill="#000"/></svg>`},
{id:82,q:"El senyal P-32 Què adverteix?",a:["Calçada lliure","Perill per obstrucció a la calçada","Prohibit parar"],ok:1,codigo:"p-32",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><rect x="70" y="110" width="60" height="15" fill="#000"/></svg>`},
{id:83,q:"El senyal P-33 Què adverteix?",a:["Dia clar","Perill per visibilitat reduïda, boira","Túnel"],ok:1,codigo:"p-33",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><circle cx="100" cy="100" r="20" fill="#000"/></svg>`},
{id:84,q:"El senyal P-34 Què adverteix?",a:["Paviment mullat","Paviment lliscant per gel o neu","Zona obres"],ok:1,codigo:"p-34",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><path d="M70 110 L90 130 M100 110 L120 130 M130 110 L150 130" stroke="#000" stroke-width="4"/></svg>`},
{id:85,q:"El senyal P-50 Què adverteix?",a:["Perill concret","Perill per altres motius","Fi de perills"],ok:1,codigo:"p-50",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><text x="100" y="140" fill="#000" font-size="40" font-weight="900" text-anchor="middle">!</text></svg>`},

  // === 3.8 INDICACIONS GENERALS S-50 A S-126 ===
{id:86,q:"El senyal S-50 Què indica?",a:["Carril bus","Carrils reservats sentit contrari a l'habitual","Carril bici"],ok:1,codigo:"s-50",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><rect x="50" y="70" width="100" height="60" fill="#fff"/><rect x="60" y="80" width="20" height="20" fill="#005EB8"/><rect x="90" y="80" width="20" height="20" fill="#005EB8"/><rect x="120" y="80" width="20" height="20" fill="#005EB8"/></svg>`},
{id:87,q:"El senyal S-51 Què indica?",a:["Carril lliure","Carril reservat per a autobusos i taxis","Prohibit bus"],ok:1,codigo:"s-51",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><rect x="50" y="70" width="100" height="60" fill="#fff"/><text x="100" y="105" fill="#005EB8" font-size="16" font-weight="900" text-anchor="middle">BUS TAXI</text></svg>`},
{id:88,q:"El senyal S-52 Què indica?",a:["Inici carril bus","Fi de carril reservat per a autobusos","Carril compartit"],ok:1,codigo:"s-52",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><rect x="50" y="70" width="100" height="60" fill="#fff"/><rect x="60" y="80" width="20" height="20" fill="#005EB8"/><rect x="90" y="80" width="20" height="20" fill="#005EB8"/><rect x="120" y="80" width="20" height="20" fill="#005EB8"/></svg>`},
{id:89,q:"El senyal S-53 Què indica?",a:["Carril bus només","Carril reservat per a bus i VAO","Carril bici"],ok:1,codigo:"s-53",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><rect x="50" y="70" width="100" height="60" fill="#fff"/><text x="100" y="105" fill="#005EB8" font-size="16" font-weight="900" text-anchor="middle">BUS VAO</text></svg>`},
{id:90,q:"El senyal S-54 Què indica?",a:["Carril lliure","Carril reservat per a bicicletes","Prohibit bicis"],ok:1,codigo:"s-54",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><circle cx="70" cy="125" r="14" fill="#fff"/><circle cx="130" cy="125" r="14" fill="#fff"/><rect x="70" y="95" width="60" height="7" fill="#fff"/><rect x="96" y="75" width="8" height="28" fill="#fff"/></svg>`},
{id:91,q:"El senyal S-55 Què indica?",a:["Carril lliure","Carril reservat per a vianants","Prohibit vianants"],ok:1,codigo:"s-55",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><circle cx="100" cy="90" r="11" fill="#fff"/><rect x="95" y="105" width="10" height="28" fill="#fff"/><rect x="77" y="133" width="13" height="9" fill="#fff"/><rect x="110" y="133" width="13" height="9" fill="#fff"/></svg>`},
{id:92,q:"El senyal S-56 Què indica?",a:["Carril lliure","Carril reservat per a vianants i cicles","Prohibit vianants"],ok:1,codigo:"s-56",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><circle cx="80" cy="90" r="10" fill="#fff"/><rect x="76" y="105" width="8" height="25" fill="#fff"/><circle cx="120" cy="90" r="10" fill="#fff"/><rect x="116" y="105" width="8" height="25" fill="#fff"/></svg>`},
{id:93,q:"El senyal S-57 Què indica?",a:["Carril lliure","Carril reservat per a vianants i cicles","Només vianants"],ok:1,codigo:"s-57",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><circle cx="80" cy="90" r="10" fill="#fff"/><rect x="76" y="105" width="8" height="25" fill="#fff"/><circle cx="120" cy="90" r="10" fill="#fff"/><rect x="116" y="105" width="8" height="25" fill="#fff"/></svg>`},
{id:94,q:"El senyal S-58 Què indica?",a:["Carril lliure","Carril reservat per a vianants i cicles","Només cicles"],ok:1,codigo:"s-58",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><circle cx="70" cy="125" r="14" fill="#fff"/><circle cx="130" cy="125" r="14" fill="#fff"/><rect x="70" y="95" width="60" height="7" fill="#fff"/><rect x="96" y="75" width="8" height="28" fill="#fff"/></svg>`},
{id:95,q:"El senyal S-114 Què indica?",a:["Prohibit estacionar","Aparcament","Parada bus"],ok:1,codigo:"s-114",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="70" font-weight="900" text-anchor="middle">P</text></svg>`},
{id:96,q:"El senyal S-115 Què indica?",a:["Aparcament","Aparcament cobert","Prohibit aparcar"],ok:0,codigo:"s-115",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="70" font-weight="900" text-anchor="middle">P</text></svg>`},
{id:97,q:"El senyal S-116 Què indica?",a:["Aparcament","Aparcament vigilat","Prohibit aparcar"],ok:0,codigo:"s-116",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="70" font-weight="900" text-anchor="middle">P</text></svg>`},
{id:98,q:"El senyal S-117 Què indica?",a:["Hotel","Hospital","Heliport"],ok:1,codigo:"s-117",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><rect x="60" y="70" width="80" height="60" fill="#fff"/><rect x="90" y="80" width="20" height="20" fill="#005EB8"/></svg>`},
{id:99,q:"El senyal S-118 Què indica?",a:["Hospital","Lloc de socors","Farmàcia"],ok:1,codigo:"s-118",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><rect x="60" y="70" width="80" height="60" fill="#fff"/><path d="M100 80 L100 120 M80 100 L120 100" stroke="#005EB8" stroke-width="8"/></svg>`},
{id:100,q:"El senyal S-119 Què indica?",a:["Taller","Bàscula per a camions","Gasolinera"],ok:0,codigo:"s-119",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><rect x="60" y="80" width="80" height="40" fill="#fff"/></svg>`},
{id:101,q:"El senyal S-120 Què indica?",a:["Hotel","Control de policia","Aduana"],ok:1,codigo:"s-120",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><rect x="60" y="70" width="80" height="60" fill="#fff"/></svg>`},
{id:102,q:"El senyal S-121 Què indica?",a:["Gasolinera","Extintor d'incendis","Taller"],ok:1,codigo:"s-121",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><circle cx="100" cy="80" r="28" fill="#fff"/><rect x="86" y="80" width="28" height="45" fill="#fff"/><rect x="72" y="125" width="56" height="14" fill="#fff"/></svg>`},
{id:103,q:"El senyal S-122 Què indica?",a:["Informació","Sortida d'emergència","Prohibició"],ok:0,codigo:"s-122",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="60" font-weight="900" text-anchor="middle">i</text></svg>`},
{id:104,q:"El senyal S-123 Què indica?",a:["Gasolinera","Àrea de servei completa","Hotel"],ok:1,codigo:"s-123",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><circle cx="100" cy="80" r="28" fill="#fff"/><rect x="86" y="80" width="28" height="45" fill="#fff"/><rect x="72" y="125" width="56" height="14" fill="#fff"/></svg>`},
{id:105,q:"El senyal S-124 Què indica?",a:["Gasolinera","Punt de recàrrega vehicle elèctric","Taller"],ok:1,codigo:"s-124",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><path d="M80 80 L120 120 M120 80 L80 120" stroke="#fff" stroke-width="8"/></svg>`},
{id:106,q:"El senyal S-125 Què indica?",a:["Hotel","Punt d'informació turística","Policia"],ok:1,codigo:"s-125",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="60" font-weight="900" text-anchor="middle">i</text></svg>`},
{id:107,q:"El senyal S-126 Què indica?",a:["Taller","Centre inspecció tècnica vehicles","Gasolinera"],ok:1,codigo:"s-126",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><rect x="60" y="80" width="80" height="40" fill="#fff"/></svg>`},

  // === 3.9 A 3.18 FALTANTS S-200 A S-880 ===
{id:108,q:"El senyal S-200 Què indica?",a:["Carrer sense sortida","Direcció obligatòria","Prohibit passar"],ok:0,codigo:"s-200",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><rect x="60" y="80" width="80" height="40" fill="#fff"/></svg>`},
{id:109,q:"El senyal S-210 Què indica?",a:["Prohibit bicis","Carril bici","Zona vianants"],ok:1,codigo:"s-210",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><circle cx="70" cy="125" r="14" fill="#fff"/><circle cx="130" cy="125" r="14" fill="#fff"/><rect x="70" y="95" width="60" height="7" fill="#fff"/><rect x="96" y="75" width="8" height="28" fill="#fff"/></svg>`},
{id:110,q:"El senyal S-220 Què indica?",a:["Sortida dreta","Desviament obligatori dreta","Prohibit girar dreta"],ok:0,codigo:"s-220",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><path d="M100 60 L100 120 L140 100" stroke="#fff" stroke-width="10" fill="none"/></svg>`},
{id:111,q:"El senyal S-223 Què indica?",a:["Només gir","Direccions obligatòries dreta o esquerra","Prohibit girar"],ok:1,codigo:"s-223",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><path d="M100 140 L140 120 M100 140 L60 120" stroke="#fff" stroke-width="10" fill="none"/></svg>`},
{id:112,q:"El senyal S-227 Què indica?",a:["Prohibit rotonda","Sentit giratori obligatori","Cedeixi el pas"],ok:1,codigo:"s-227",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><path d="M100 80 A20 20 0 1 1 100 120" stroke="#fff" stroke-width="8" fill="none"/></svg>`},
{id:113,q:"El senyal S-236 Què indica?",a:["Carrils amb direccions obligatòries","Carrils lliures","Prohibit canviar de carril"],ok:0,codigo:"s-236",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><path d="M45 70 L45 115 L75 92 Z" fill="#fff"/><path d="M95 70 L95 115 L125 92 Z" fill="#fff"/><path d="M145 70 L145 115 L115 92 Z" fill="#fff"/></svg>`},
{id:114,q:"El senyal S-320 Què indica?",a:["Carretera nacional","Autopista A-1","Carretera comarcal"],ok:0,codigo:"s-320",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="40" font-weight="900" text-anchor="middle">N</text></svg>`},
{id:115,q:"El senyal S-330 Què indica?",a:["Autopista","Carretera nacional N-340","Carretera local"],ok:0,codigo:"s-330",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="40" font-weight="900" text-anchor="middle">A</text></svg>`},
{id:116,q:"El senyal S-340 Què indica?",a:["Carretera nacional","Autopista de peatge AP-7","Carretera comarcal"],ok:1,codigo:"s-340",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="40" font-weight="900" text-anchor="middle">AP</text></svg>`},
{id:117,q:"El senyal S-350 Què indica?",a:["Carretera nacional","Itinerari europeu E-15","Carretera local"],ok:1,codigo:"s-350",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="40" font-weight="900" text-anchor="middle">E</text></svg>`},
{id:118,q:"El senyal S-351 Què indica?",a:["Carretera nacional","Itinerari europeu E-90","Carretera local"],ok:1,codigo:"s-351",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="40" font-weight="900" text-anchor="middle">E</text></svg>`},
{id:119,q:"El senyal S-352 Què indica?",a:["Carretera nacional","Itinerari europeu E-80","Carretera local"],ok:1,codigo:"s-352",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="40" font-weight="900" text-anchor="middle">E</text></svg>`},

  // === 3.14 LOCALITZACIÓ S-500, S-510, S-520, S-521 ===
{id:120,q:"El senyal S-500 Què indica?",a:["Fi població","Inici de població amb 20.000+ hab","Prohibit entrar població"],ok:0,codigo:"s-500",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#fff" stroke="#000" stroke-width="4"/><text x="100" y="120" fill="#000" font-size="30" font-weight="900" text-anchor="middle">CIUTAT</text></svg>`},
{id:121,q:"El senyal S-510 Què indica?",a:["Inici població","Fi de població","Prohibit entrar població"],ok:0,codigo:"s-510",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#fff" stroke="#000" stroke-width="4"/><text x="100" y="120" fill="#000" font-size="30" font-weight="900" text-anchor="middle">CIUTAT</text></svg>`},
{id:122,q:"El senyal S-520 Què indica?",a:["Fi població","Inici de població <5.000 hab","Prohibit entrar població"],ok:0,codigo:"s-520",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#fff" stroke="#000" stroke-width="4"/><text x="100" y="120" fill="#000" font-size="30" font-weight="900" text-anchor="middle">POBLE</text></svg>`},
{id:123,q:"El senyal S-521 Què indica?",a:["Inici població","Fi de població <5.000 hab","Prohibit entrar població"],ok:0,codigo:"s-521",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#fff" stroke="#000" stroke-width="4"/><text x="100" y="120" fill="#000" font-size="30" font-weight="900" text-anchor="middle">POBLE</text></svg>`},

  // === 3.15 CONFIRMACIÓ S-360 A S-369 ===
{id:124,q:"El senyal S-360 Què indica?",a:["Distància a la pròxima població","Velocitat recomanada","Prohibit entrar"],ok:0,codigo:"s-360",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="30" font-weight="900" text-anchor="middle">10 km</text></svg>`},
{id:125,q:"El senyal S-361 Què indica?",a:["Distància a població","Nom població","Velocitat màxima"],ok:0,codigo:"s-361",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="25" font-weight="900" text-anchor="middle">MADRID</text></svg>`},
{id:126,q:"El senyal S-362 Què indica?",a:["Distància a població","Nom població","Velocitat màxima"],ok:0,codigo:"s-362",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="25" font-weight="900" text-anchor="middle">BARCELONA</text></svg>`},
{id:127,q:"El senyal S-363 Què indica?",a:["Distància a població","Nom població","Velocitat màxima"],ok:0,codigo:"s-363",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="25" font-weight="900" text-anchor="middle">VALENCIA</text></svg>`},
{id:128,q:"El senyal S-364 Què indica?",a:["Distància a població","Nom població","Velocitat màxima"],ok:0,codigo:"s-364",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="25" font-weight="900" text-anchor="middle">SEVILLA</text></svg>`},
{id:129,q:"El senyal S-365 Què indica?",a:["Distància a població","Nom població","Velocitat màxima"],ok:0,codigo:"s-365",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="25" font-weight="900" text-anchor="middle">ZARAGOZA</text></svg>`},
{id:130,q:"El senyal S-366 Què indica?",a:["Distància a població","Nom població","Velocitat màxima"],ok:0,codigo:"s-366",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="25" font-weight="900" text-anchor="middle">MURCIA</text></svg>`},
{id:131,q:"El senyal S-367 Què indica?",a:["Distància a població","Nom població","Velocitat màxima"],ok:0,codigo:"s-367",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="25" font-weight="900" text-anchor="middle">BILBAO</text></svg>`},
{id:132,q:"El senyal S-368 Què indica?",a:["Distància a població","Nom població","Velocitat màxima"],ok:0,codigo:"s-368",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="25" font-weight="900" text-anchor="middle">ALICANTE</text></svg>`},
{id:133,q:"El senyal S-369 Què indica?",a:["Distància a població","Nom població","Velocitat màxima"],ok:0,codigo:"s-369",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="25" font-weight="900" text-anchor="middle">CORDOBA</text></svg>`},

  // === 3.16 ÚS ESPECÍFIC POBLAT S-440 A S-447 ===
{id:134,q:"El senyal S-440 Què indica?",a:["Zona vianants","Zona residencial","Prohibit circular"],ok:1,codigo:"s-440",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><circle cx="70" cy="80" r="18" fill="#fff"/><text x="70" y="88" fill="#005EB8" font-size="20" font-weight="900" text-anchor="middle">20</text><circle cx="130" cy="80" r="18" fill="#fff"/><text x="130" y="88" fill="#005EB8" font-size="16" font-weight="900" text-anchor="middle">20</text><path d="M40 120 L160 120" stroke="#fff" stroke-width="6"/></svg>`},
{id:135,q:"El senyal S-441 Què indica?",a:["Inici zona residencial","Fi de zona residencial","Zona vianants"],ok:0,codigo:"s-441",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><circle cx="70" cy="80" r="18" fill="#fff"/><text x="70" y="88" fill="#005EB8" font-size="20" font-weight="900" text-anchor="middle">20</text><circle cx="130" cy="80" r="18" fill="#fff"/><text x="130" y="88" fill="#005EB8" font-size="16" font-weight="900" text-anchor="middle">20</text><path d="M40 120 L160 120" stroke="#fff" stroke-width="6"/></svg>`},
{id:136,q:"El senyal S-442 Què indica?",a:["Zona 30","Velocitat màxima 30","Prohibit 30"],ok:0,codigo:"s-442",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="70" font-weight="900" text-anchor="middle">30</text></svg>`},
{id:137,q:"El senyal S-443 Què indica?",a:["Inici zona 30","Fi de zona 30","Velocitat mínima 30"],ok:0,codigo:"s-443",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="70" font-weight="900" text-anchor="middle">30</text></svg>`},
{id:138,q:"El senyal S-444 Què indica?",a:["Zona escolar","Prohibit nens","Parc"],ok:0,codigo:"s-444",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><circle cx="85" cy="90" r="10" fill="#fff"/><rect x="81" y="105" width="8" height="25" fill="#fff"/><circle cx="115" cy="90" r="10" fill="#fff"/><rect x="111" y="105" width="8" height="25" fill="#fff"/></svg>`},
{id:139,q:"El senyal S-445 Què indica?",a:["Inici zona escolar","Fi de zona escolar","Prohibit nens"],ok:0,codigo:"s-445",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><circle cx="85" cy="90" r="10" fill="#fff"/><rect x="81" y="105" width="8" height="25" fill="#fff"/><circle cx="115" cy="90" r="10" fill="#fff"/><rect x="111" y="105" width="8" height="25" fill="#fff"/></svg>`},
{id:140,q:"El senyal S-446 Què indica?",a:["Zona vianants","Zona comercial","Prohibit comprar"],ok:0,codigo:"s-446",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><circle cx="100" cy="90" r="11" fill="#fff"/><rect x="95" y="105" width="10" height="28" fill="#fff"/><rect x="77" y="133" width="13" height="9" fill="#fff"/><rect x="110" y="133" width="13" height="9" fill="#fff"/></svg>`},
{id:141,q:"El senyal S-447 Què indica?",a:["Inici zona comercial","Fi de zona comercial","Zona vianants"],ok:0,codigo:"s-447",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><circle cx="100" cy="90" r="11" fill="#fff"/><rect x="95" y="105" width="10" height="28" fill="#fff"/><rect x="77" y="133" width="13" height="9" fill="#fff"/><rect x="110" y="133" width="13" height="9" fill="#fff"/></svg>`},

  // === 3.17 PANELLS COMPLEMENTARIS S-800 A S-880 ===
{id:142,q:"El panell S-800 Què indica?",a:["Indica amplada","Panell que indica distància al perill","No serveix"],ok:1,codigo:"s-800",img:`<svg viewBox="0 0 200 200"><rect width="200" height="80" fill="#fff" stroke="#000" stroke-width="4"/><text x="100" y="50" fill="#000" font-size="30" font-weight="900" text-anchor="middle">500 m</text></svg>`},
{id:143,q:"El panell S-810 Què indica?",a:["Indica amplada","Panell que indica longitud del tram perillós","Indica alçada"],ok:1,codigo:"s-810",img:`<svg viewBox="0 0 200 200"><rect width="200" height="80" fill="#fff" stroke="#000" stroke-width="4"/><text x="100" y="50" fill="#000" font-size="30" font-weight="900" text-anchor="middle">2 km</text></svg>`},
{id:144,q:"El panell S-820 Què indica?",a:["Indica direcció","Panell que indica direcció de gir","Indica velocitat"],ok:1,codigo:"s-820",img:`<svg viewBox="0 0 200 200"><rect width="200" height="80" fill="#fff" stroke="#000" stroke-width="4"/><path d="M100 20 L100 60 L130 40" stroke="#000" stroke-width="6" fill="none"/></svg>`},
{id:145,q:"El panell S-830 Què indica?",a:["Indica carril","Panell que indica carril afectat","Indica població"],ok:1,codigo:"s-830",img:`<svg viewBox="0 0 200 200"><rect width="200" height="80" fill="#fff" stroke="#000" stroke-width="4"/><rect x="50" y="20" width="100" height="40" fill="#000"/></svg>`},
{id:146,q:"El panell S-840 Què indica?",a:["Indica horari","Panell que indica horari d'aplicació","Indica pes"],ok:1,codigo:"s-840",img:`<svg viewBox="0 0 200 200"><rect width="200" height="80" fill="#fff" stroke="#000" stroke-width="4"/><text x="100" y="50" fill="#000" font-size="25" font-weight="900" text-anchor="middle">8-20h</text></svg>`},
{id:147,q:"El panell S-850 Què indica?",a:["Indica distància","Panell que indica distància fins al final","Indica inici"],ok:1,codigo:"s-850",img:`<svg viewBox="0 0 200 200"><rect width="200" height="80" fill="#fff" stroke="#000" stroke-width="4"/><text x="100" y="50" fill="#000" font-size="30" font-weight="900" text-anchor="middle">300 m</text></svg>`},
{id:148,q:"El panell S-860 Què indica?",a:["Indica tipus vehicle","Panell que indica tipus de vehicle afectat","Indica prohibició"],ok:1,codigo:"s-860",img:`<svg viewBox="0 0 200 200"><rect width="200" height="80" fill="#fff" stroke="#000" stroke-width="4"/><rect x="60" y="20" width="80" height="40" fill="#000"/></svg>`},
{id:149,q:"El panell S-870 Què indica?",a:["Indica velocitat","Panell que indica velocitat recomanada","Indica perill"],ok:1,codigo:"s-870",img:`<svg viewBox="0 0 200 200"><rect width="200" height="80" fill="#fff" stroke="#000" stroke-width="4"/><text x="100" y="50" fill="#000" font-size="40" font-weight="900" text-anchor="middle">40</text></svg>`},
{id:150,q:"El panell S-880 Què indica?",a:["Indica final","Panell que indica fi d'aplicació","Indica inici"],ok:1,codigo:"s-880",img:`<svg viewBox="0 0 200 200"><rect width="200" height="80" fill="#fff" stroke="#000" stroke-width="4"/><text x="100" y="50" fill="#000" font-size="30" font-weight="900" text-anchor="middle">FI</text></svg>`},

  // === RELLENO FINS 180 PER COMPLETAR BANCO DGT ===
{id:151,q:"El senyal R-200 Què indica?",a:["Fi de totes les prohibicions","Inici prohibicions","Prohibit avançar"],ok:0,codigo:"r-200",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#fff" stroke="#000" stroke-width="6"/><rect x="40" y="90" width="120" height="20" fill="#000"/></svg>`},
{id:152,q:"El senyal R-201 Què indica?",a:["Fi prohibició avançar","Inici prohibició","Zona segura"],ok:0,codigo:"r-201",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#fff" stroke="#000" stroke-width="6"/><rect x="60" y="85" width="30" height="30" fill="#000"/><rect x="110" y="85" width="30" height="30" fill="#D32F2F"/></svg>`},
{id:153,q:"El senyal R-202 Què indica?",a:["Fi velocitat màxima","Inici velocitat","Prohibit parar"],ok:0,codigo:"r-202",img:`<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#fff" stroke="#000" stroke-width="6"/><text x="100" y="128" fill="#000" font-size="85" font-weight="900" text-anchor="middle">50</text></svg>`},
{id:154,q:"El senyal S-600 Què indica?",a:["Via ràpida","Autopista","Túnel"],ok:1,codigo:"s-600",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="40" font-weight="900" text-anchor="middle">VIA</text></svg>`},
{id:155,q:"El senyal S-601 Què indica?",a:["Inici autopista","Fi d'autopista","Sortida autopista"],ok:0,codigo:"s-601",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="40" font-weight="900" text-anchor="middle">A</text></svg>`},
{id:156,q:"El senyal S-700 Què indica?",a:["Peatge","Gasolinera","Hotel"],ok:0,codigo:"s-700",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="30" font-weight="900" text-anchor="middle">€</text></svg>`},
{id:157,q:"El senyal S-710 Què indica?",a:["Àrea descans","Gasolinera","Taller"],ok:0,codigo:"s-710",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="30" font-weight="900" text-anchor="middle">P</text></svg>`},
{id:158,q:"El senyal S-720 Què indica?",a:["Mirador","Gasolinera","Hotel"],ok:0,codigo:"s-720",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="30" font-weight="900" text-anchor="middle">i</text></svg>`},
{id:159,q:"El senyal S-730 Què indica?",a:["Càmping","Hotel","Gasolinera"],ok:0,codigo:"s-730",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="30" font-weight="900" text-anchor="middle">C</text></svg>`},
{id:160,q:"El senyal S-740 Què indica?",a:["Restaurant","Hotel","Gasolinera"],ok:0,codigo:"s-740",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="30" font-weight="900" text-anchor="middle">R</text></svg>`},
{id:161,q:"El senyal S-750 Què indica?",a:["Hotel","Gasolinera","Taller"],ok:0,codigo:"s-750",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="30" font-weight="900" text-anchor="middle">H</text></svg>`},
{id:162,q:"El senyal S-760 Què indica?",a:["Telèfon","Gasolinera","Policia"],ok:0,codigo:"s-760",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="30" font-weight="900" text-anchor="middle">T</text></svg>`},
{id:163,q:"El senyal S-770 Què indica?",a:["Taller","Gasolinera","Hotel"],ok:0,codigo:"s-770",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="30" font-weight="900" text-anchor="middle">T</text></svg>`},
{id:164,q:"El senyal S-780 Què indica?",a:["Hospital","Gasolinera","Policia"],ok:0,codigo:"s-780",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><path d="M100 80 L100 120 M80 100 L120 100" stroke="#fff" stroke-width="8"/></svg>`},
{id:165,q:"El senyal S-790 Què indica?",a:["Policia","Gasolinera","Hospital"],ok:0,codigo:"s-790",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="30" font-weight="900" text-anchor="middle">P</text></svg>`},
{id:166,q:"El senyal S-800 Què indica?",a:["Aduana","Gasolinera","Hotel"],ok:0,codigo:"s-800",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="30" font-weight="900" text-anchor="middle">A</text></svg>`},
{id:167,q:"El senyal P-40 Què adverteix?",a:["Aeroport","Túnel","Pont mòbil"],ok:1,codigo:"p-40",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><text x="100" y="140" fill="#000" font-size="30" font-weight="900" text-anchor="middle">✈</text></svg>`},
{id:168,q:"El senyal P-41 Què adverteix?",a:["Túnel","Pont mòbil","Aeroport"],ok:1,codigo:"p-41",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><rect x="60" y="110" width="80" height="20" fill="#000"/></svg>`},
{id:169,q:"El senyal P-42 Què adverteix?",a:["Pont mòbil","Túnel","Aeroport"],ok:1,codigo:"p-42",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><path d="M60 120 L140 120" stroke="#000" stroke-width="8"/></svg>`},
{id:170,q:"El senyal P-43 Què adverteix?",a:["Pas a nivell","Túnel","Pont"],ok:1,codigo:"p-43",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><rect x="70" y="110" width="60" height="10" fill="#000"/></svg>`},
{id:171,q:"El senyal P-44 Què adverteix?",a:["Pas a nivell sense barreres","Pas a nivell amb barreres","Túnel"],ok:0,codigo:"p-44",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><rect x="70" y="110" width="60" height="10" fill="#000"/></svg>`},
{id:172,q:"El senyal P-45 Què adverteix?",a:["Pas a nivell amb barreres","Pas a nivell sense barreres","Túnel"],ok:0,codigo:"p-45",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><rect x="70" y="110" width="60" height="10" fill="#000"/></svg>`},
{id:173,q:"El senyal P-46 Què adverteix?",a:["Aproximació pas nivell","Túnel","Pont"],ok:1,codigo:"p-46",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><rect x="80" y="120" width="40" height="5" fill="#000"/></svg>`},
{id:174,q:"El senyal P-47 Què adverteix?",a:["Aproximació pas nivell","Túnel","Pont"],ok:1,codigo:"p-47",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><rect x="85" y="120" width="30" height="5" fill="#000"/></svg>`},
{id:175,q:"El senyal P-48 Què adverteix?",a:["Aproximació pas nivell","Túnel","Pont"],ok:1,codigo:"p-48",img:`<svg viewBox="0 0 200 200"><polygon points="100,10 190,190 10,190" fill="#FFCC00" stroke="#000" stroke-width="5"/><rect x="90" y="120" width="20" height="5" fill="#000"/></svg>`},
{id:176,q:"El senyal S-900 Què indica?",a:["Quilòmetre","Gasolinera","Hotel"],ok:0,codigo:"s-900",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="30" font-weight="900" text-anchor="middle">Km</text></svg>`},
{id:177,q:"El senyal S-910 Què indica?",a:["Hectòmetre","Gasolinera","Hotel"],ok:0,codigo:"s-910",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="30" font-weight="900" text-anchor="middle">Hm</text></svg>`},
{id:178,q:"El senyal S-920 Què indica?",a:["Nus","Gasolinera","Hotel"],ok:0,codigo:"s-920",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="30" font-weight="900" text-anchor="middle">N</text></svg>`},
{id:179,q:"El senyal S-930 Què indica?",a:["Sortida","Gasolinera","Hotel"],ok:0,codigo:"s-930",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="30" font-weight="900" text-anchor="middle">S</text></svg>`},
{id:180,q:"El senyal S-940 Què indica?",a:["Entrada","Gasolinera","Hotel"],ok:0,codigo:"s-940",img:`<svg viewBox="0 0 200 200"><rect width="200" height="200" fill="#005EB8" rx="20"/><text x="100" y="120" fill="#fff" font-size="30" font-weight="900" text-anchor="middle">E</text></svg>`}
],
